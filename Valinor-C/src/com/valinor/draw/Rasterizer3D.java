package com.valinor.draw;

import com.valinor.ClientConstants;
import com.valinor.cache.Archive;
import com.valinor.cache.graphics.IndexedImage;
...
public final class Rasterizer3D extends Rasterizer2D {
    ...
    public static void drawTexturedTriangle1(
        ...
        if(texels == null) {
            ...
            Nz -= Pz;
            Ny -= Py;
            int Oa = (Nx * Pz - Nz * Px) * SceneGraph.focalLength << 5;
            int Ha = Nz * Py - Ny * Pz << 8;
            int Va = Ny * Px - Nx * Py << 5;
            int Ob = (Mx * Pz - Mz * Px) * SceneGraph.focalLength << 5;
            int Hb = Mz * Py - My * Pz << 8;
            int Vb = My * Px - Mx * Py << 5;
            int Oc = (Mz * Nx - Mx * Nz) * SceneGraph.focalLength << 5;
