...
public class CustomPets {
    ...
    public static void unpack(int id) {
        ...
        if(id == NAGINI) {
            ...
            definition.modelId = new int[] {13910};
            definition.widthScale = 45;
            definition.heightScale = 45;
        ...
        if (id == ANCIENT_KING_BLACK_DRAGON_PET) {
            ...
            definition.modelId = new int[]{17414, 17415, 17429, 17422, 17423};
        ...
        if (id == ANCIENT_CHAOS_ELEMENTAL_PET) {
            ...
            definition.modelCustomColor4 = 235;
            definition.modelId = new int[]{28256};
        ...
        if (id == ANCIENT_BARRELCHEST_PET) {
            ...
            definition.heightScale = 40;
            definition.widthScale = 40;
            definition.modelId = new int[]{22790};
        ...
        if (id == FAWKES) {
            ...
            definition.modelId = new int[] {26853};
        ...
        if (id == BLOOD_FIREBIRD) {
            ...
            definition.ambient = 40;
            definition.modelId = new int[] {26852};
        ...
        if (id == DHAROK_PET) {
            ...
            definition.modelId = new int[]{6652, 6671, 6640, 6661, 6703, 6679};
        ...
        if (id == ZOMBIES_CHAMPION) {
            ...
            definition.modelId = new int[]{20949};
        ...
        if (id == PET_ZILYANA_WHITE) {
            ...
            definition.ambient = 30;
            definition.contrast = 30;
            definition.modelId = new int[]{27989, 27937, 27985, 27968, 27990};
        ...
        if (id == PET_GENERAL_GRAARDOR_BLACK) {
            ...
            definition.ambient = 30;
            definition.contrast = 30;
            definition.modelId = new int[]{27660, 27665};
        ...
        if (id == PET_KREEARRA_WHITE) {
            ...
            definition.ambient = 30;
            definition.contrast = 30;
            definition.modelId = new int[]{28019, 28021, 28020};
        ...
        if (id == PET_KRIL_TSUTSAROTH_BLACK) {
            ...
            definition.ambient = 30;
            definition.contrast = 30;
            definition.modelId = new int[]{27683, 27681, 27692, 27682, 27690};
        ...
        if (id == BABY_SQUIRT) {
            ...
            definition.modelId = new int[]{25000, 25006, 25001, 25002, 25003, 25004, 25005};
        ...
        if (id == JAWA) {
            ...
            definition.modelId = new int[]{28285, 181, 249, 28286, 28226, 176, 28223};
        ...
        if (id == BABY_DARK_BEAST) {
            ...
            definition.modelId = new int[]{26395};
        ...
        if (id == BABY_ABYSSAL_DEMON) {
            ...
            definition.modelId = new int[] {5062};
        ...
        if (id == GENIE_PET) {
            ...
            definition.modelId = new int[]{231, 241, 252, 315, 173, 176, 264, 270};
        ...
        if (id == KERBEROS_PET) {
            ...
            definition.modelId = new int[]{29240};
        ...
        if (id == SKORPIOS_PET) {
            ...
            definition.contrast = 30;
            definition.modelId = new int[]{29193};
        ...
        if (id == ARTIO_PET) {
            ...
            definition.ambient = 30;
            definition.contrast = 30;
            definition.modelId = new int[]{28298};
        ...
        if (id == FOUNDER_IMP) {
            ...
            definition.modelId = new int[]{58916};
        ...
        if (id == JALTOK_JAD) {
            ...
            definition.modelId = new int[]{33012};
            definition.widthScale = 20;
            definition.heightScale = 20;
        ...
        if (id == ZRIAWK) {
            ...
            definition.modelId = new int[]{6458};
        ...
        if(id == SKELETON_HELLHOUND_PET) {
            definition.modelId = new int[]{26262};
