...
public enum SpecialAttackBars {
    ...
    TIER_5_4_MSB(16226, "Snapshot: Fire two arrows within quick succession, but with reduced accuracy.", 55.0, 31387, 7549, 7561),
    TIER_5_3_MSB(16225, "Snapshot: Fire two arrows within quick succession, but with reduced accuracy.", 55.0, 31387, 7549, 7561),
    TIER_5_2_MSB(16224, "Snapshot: Fire two arrows within quick succession, but with reduced accuracy.", 55.0, 31387, 7549, 7561),
    TIER_5_1_MSB(16223, "Snapshot: Fire two arrows within quick succession, but with reduced accuracy.", 55.0, 31387, 7549, 7561),
    TIER_5_MSB(16222, "Snapshot: Fire two arrows within quick succession, but with reduced accuracy.", 55.0, 31387, 7549, 7561),
    TIER_4_MSB(16221, "Snapshot: Fire two arrows within quick succession, but with reduced accuracy.", 55.0, 31387, 7549, 7561),
    TIER_3_MSB(16220, "Snapshot: Fire two arrows within quick succession, but with reduced accuracy.", 55.0, 31387, 7549, 7561),
    TIER_2_MSB(16216, "Snapshot: Fire two arrows within quick succession, but with reduced accuracy.", 55.0, 31387, 7549, 7561),
    TIER_1_MSB(16218, "Snapshot: Fire two arrows within quick succession, but with reduced accuracy.", 55.0, 31387, 7549, 7561),
    ...
    T5_4_STAFF_OF_LIGHT(16276, "Power of Death: Reduce all melee damage you receive by 50% for the next minute while the staff remains equipped. Stacks with Protect from Melee.", 100.0, 31349, 7474, 7486),
    T5_3_STAFF_OF_LIGHT(16275, "Power of Death: Reduce all melee damage you receive by 50% for the next minute while the staff remains equipped. Stacks with Protect from Melee.", 100.0, 31349, 7474, 7486),
    T5_2_STAFF_OF_LIGHT(16274, "Power of Death: Reduce all melee damage you receive by 50% for the next minute while the staff remains equipped. Stacks with Protect from Melee.", 100.0, 31349, 7474, 7486),
    T5_1_STAFF_OF_LIGHT(16273, "Power of Death: Reduce all melee damage you receive by 50% for the next minute while the staff remains equipped. Stacks with Protect from Melee.", 100.0, 31349, 7474, 7486),
    T5_STAFF_OF_LIGHT(16272, "Power of Death: Reduce all melee damage you receive by 50% for the next minute while the staff remains equipped. Stacks with Protect from Melee.", 100.0, 31349, 7474, 7486),
    T4_STAFF_OF_LIGHT(16271, "Power of Death: Reduce all melee damage you receive by 50% for the next minute while the staff remains equipped. Stacks with Protect from Melee.", 100.0, 31349, 7474, 7486),
    T3_STAFF_OF_LIGHT(16270, "Power of Death: Reduce all melee damage you receive by 50% for the next minute while the staff remains equipped. Stacks with Protect from Melee.", 100.0, 31349, 7474, 7486),
    T2_STAFF_OF_LIGHT(16269, "Power of Death: Reduce all melee damage you receive by 50% for the next minute while the staff remains equipped. Stacks with Protect from Melee.", 100.0, 31349, 7474, 7486),
    ...
    TIER_5_4_D_LONG(16253, "Cleave: Deal a powerful attack that inflicts 15% more damage.", 25.0, 31351, 7599, 7611),
    TIER_5_3_D_LONG(16252, "Cleave: Deal a powerful attack that inflicts 15% more damage.", 25.0, 31351, 7599, 7611),
    TIER_5_2_D_LONG(16251, "Cleave: Deal a powerful attack that inflicts 15% more damage.", 25.0, 31351, 7599, 7611),
    TIER_5_1_D_LONG(16250, "Cleave: Deal a powerful attack that inflicts 15% more damage.", 25.0, 31351, 7599, 7611),
    TIER_5_D_LONG(16249, "Cleave: Deal a powerful attack that inflicts 15% more damage.", 25.0, 31351, 7599, 7611),
    TIER_4_D_LONG(16248, "Cleave: Deal a powerful attack that inflicts 15% more damage.", 25.0, 31351, 7599, 7611),
    TIER_3_D_LONG(16247, "Cleave: Deal a powerful attack that inflicts 15% more damage.", 25.0, 31351, 7599, 7611),
    TIER_2_D_LONG(16246, "Cleave: Deal a powerful attack that inflicts 15% more damage.", 25.0, 31351, 7599, 7611),
    TIER_1_D_LONG(16245, "Cleave: Deal a powerful attack that inflicts 15% more damage.", 25.0, 31351, 7599, 7611),
    ...
    ABYSSAL_WHIP_t1(15441, "Energy Drain: Deal an attack with 25% increased accuracy that siphons 10% of your target's run energy.", 50.0, 31375, 12323, 12335),
    ABYSSAL_WHIP_t2(15442, "Energy Drain: Deal an attack with 25% increased accuracy that siphons 10% of your target's run energy.", 50.0, 31375, 12323, 12335),
    ABYSSAL_WHIP_t3(15443, "Energy Drain: Deal an attack with 25% increased accuracy that siphons 10% of your target's run energy.", 50.0, 31375, 12323, 12335),
    ABYSSAL_WHIP_t4(15444, "Energy Drain: Deal an attack with 25% increased accuracy that siphons 10% of your target's run energy.", 50.0, 31375, 12323, 12335),
    ABYSSAL_WHIP_t5(15445, "Energy Drain: Deal an attack with 25% increased accuracy that siphons 10% of your target's run energy.", 50.0, 31375, 12323, 12335),
    ABYSSAL_WHIP_t5_1(15446, "Energy Drain: Deal an attack with 25% increased accuracy that siphons 10% of your target's run energy.", 50.0, 31375, 12323, 12335),
    ABYSSAL_WHIP_t5_2(15447, "Energy Drain: Deal an attack with 25% increased accuracy that siphons 10% of your target's run energy.", 50.0, 31375, 12323, 12335),
    ABYSSAL_WHIP_t5_3(15448, "Energy Drain: Deal an attack with 25% increased accuracy that siphons 10% of your target's run energy.", 50.0, 31375, 12323, 12335),
    ABYSSAL_WHIP_t5_4(15449, "Energy Drain: Deal an attack with 25% increased accuracy that siphons 10% of your target's run energy.", 50.0, 31375, 12323, 12335),
    ...
    GRANITE_MAUL_t1(16200, "Quick Smash: Deal an extra attack instantly.", 50.0, 31376, 7474, 7486),
    GRANITE_MAUL_t2(16201, "Quick Smash: Deal an extra attack instantly.", 50.0, 31376, 7474, 7486),
    GRANITE_MAUL_t3(16202, "Quick Smash: Deal an extra attack instantly.", 50.0, 31376, 7474, 7486),
    GRANITE_MAUL_t4(16203, "Quick Smash: Deal an extra attack instantly.", 50.0, 31376, 7474, 7486),
    GRANITE_MAUL_t5(16204, "Quick Smash: Deal an extra attack instantly.", 50.0, 31376, 7474, 7486),
    GRANITE_MAUL_t5_1(16205, "Quick Smash: Deal an extra attack instantly.", 50.0, 31376, 7474, 7486),
    GRANITE_MAUL_t5_2(16206, "Quick Smash: Deal an extra attack instantly.", 50.0, 31376, 7474, 7486),
    GRANITE_MAUL_t5_3(16207, "Quick Smash: Deal an extra attack instantly.", 50.0, 31376, 7474, 7486),
    GRANITE_MAUL_t5_4(16208, "Quick Smash: Deal an extra attack instantly.", 50.0, 31376, 7474, 7486),
    ...
    DRAGON_MACE_t1(16254, "Shatter: Increase damage by 50% and accuracy by 25% for one hit.", 25.0, 31406, 7624, 7636),
    DRAGON_MACE_2(16255, "Shatter: Increase damage by 50% and accuracy by 25% for one hit.", 25.0, 31406, 7624, 7636),
    DRAGON_MACE_t3(16256, "Shatter: Increase damage by 50% and accuracy by 25% for one hit.", 25.0, 31406, 7624, 7636),
    DRAGON_MACE_t4(16257, "Shatter: Increase damage by 50% and accuracy by 25% for one hit.", 25.0, 31406, 7624, 7636),
    DRAGON_MACE_t5(16258, "Shatter: Increase damage by 50% and accuracy by 25% for one hit.", 25.0, 31406, 7624, 7636),
    DRAGON_MACE_t5_1(16259, "Shatter: Increase damage by 50% and accuracy by 25% for one hit.", 25.0, 31406, 7624, 7636),
    DRAGON_MACE_t5_2(16260, "Shatter: Increase damage by 50% and accuracy by 25% for one hit.", 25.0, 31406, 7624, 7636),
    DRAGON_MACE_t5_3(16261, "Shatter: Increase damage by 50% and accuracy by 25% for one hit.", 25.0, 31406, 7624, 7636),
    DRAGON_MACE_t5_4(16262, "Shatter: Increase damage by 50% and accuracy by 25% for one hit.", 25.0, 31406, 7624, 7636),
    ...
    DRAGON_DAGGER_CUSTOM_1(16209, "Puncture: Deal two quick slashes with 25% increased accuracy and 15% increased damage.", 25.0, 31369, 7574, 7586),
    DRAGON_DAGGER_CUSTOM_2(16210, "Puncture: Deal two quick slashes with 25% increased accuracy and 15% increased damage.", 25.0, 31369, 7574, 7586),
    DRAGON_DAGGER_CUSTOM_3(16211, "Puncture: Deal two quick slashes with 25% increased accuracy and 15% increased damage.", 25.0, 31369, 7574, 7586),
    DRAGON_DAGGER_CUSTOM_4(16213, "Puncture: Deal two quick slashes with 25% increased accuracy and 15% increased damage.", 25.0, 31369, 7574, 7586),
    DRAGON_DAGGER_CUSTOM_5(16214, "Puncture: Deal two quick slashes with 25% increased accuracy and 15% increased damage.", 25.0, 31369, 7574, 7586),
    DRAGON_DAGGER_CUSTOM_5_1(16215, "Puncture: Deal two quick slashes with 25% increased accuracy and 15% increased damage.", 25.0, 31369, 7574, 7586),
    DRAGON_DAGGER_CUSTOM_5_2(16216, "Puncture: Deal two quick slashes with 25% increased accuracy and 15% increased damage.", 25.0, 31369, 7574, 7586),
    DRAGON_DAGGER_CUSTOM_5_3(16217, "Puncture: Deal two quick slashes with 25% increased accuracy and 15% increased damage.", 25.0, 31369, 7574, 7586),
    DRAGON_DAGGER_CUSTOM_5_4(16218, "Puncture: Deal two quick slashes with 25% increased accuracy and 15% increased damage.", 25.0, 31369, 7574, 7586),
    DRAGON_DAGGER_CUSTOM_5_5(16219, "Puncture: Deal two quick slashes with 25% increased accuracy and 15% increased damage.", 25.0, 31369, 7574, 7586),
    ...
    DRAGON_SCIMITAR_t1(16236,"Sever: Deal a slash with increased accuracy that prevents your target from using protection prayers for 5 seconds if it successfully hits.",55.0, 31449, 7599, 7611),
    DRAGON_SCIMITAR_t2(16237,"Sever: Deal a slash with increased accuracy that prevents your target from using protection prayers for 5 seconds if it successfully hits.",55.0, 31449, 7599, 7611),
    DRAGON_SCIMITAR_t3(16238,"Sever: Deal a slash with increased accuracy that prevents your target from using protection prayers for 5 seconds if it successfully hits.",55.0, 31449, 7599, 7611),
    DRAGON_SCIMITAR_t4(16239,"Sever: Deal a slash with increased accuracy that prevents your target from using protection prayers for 5 seconds if it successfully hits.",55.0, 31449, 7599, 7611),
    DRAGON_SCIMITAR_t5(16240,"Sever: Deal a slash with increased accuracy that prevents your target from using protection prayers for 5 seconds if it successfully hits.",55.0, 31449, 7599, 7611),
    DRAGON_SCIMITAR_t5_1(16241,"Sever: Deal a slash with increased accuracy that prevents your target from using protection prayers for 5 seconds if it successfully hits.",55.0, 31449, 7599, 7611),
    ...
    KORASI_SWORD(19780,"",60.0, 31449, 7599, 7611),
