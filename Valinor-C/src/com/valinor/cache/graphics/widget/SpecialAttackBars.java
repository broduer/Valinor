...
public enum SpecialAttackBars {
    ...
    ZARYTE_CROSSBOW(26374, "Evoke: The special attack will guarantee the special effect of enchanted bolts to occur on the next shot, with doubled accuracy.", 75.0, 31344, 7549, 7561),
    ...
    TOXIC_STAFF_OF_THE_DEAD_C(32006, "Power of Death: Reduce all melee damage you receive by 50% for the next minute while the staff remains equipped. Stacks with Protect from Melee.", 100.0, 31391, 7474, 7486),
    ...
    ANCIENT_WARRIOR_SWORD_C(31983,"Ancient warrior: Summons a powerful ancient warrior that can deal up to 55 damage.",100,24145,7599,7611),
    ANCIENT_WARRIOR_AXE_C(31984,"Ancient warrior: Deal an attack, with double accuracy, that inflicts 15% more damage and drains your target's prayer and defence by the damage dealt.", 50,24146,7499,7511),
    ANCIENT_WARRIOR_MAUL_C(31981, "Ancient warrior: Deal an attack with 50% more accuracy, 25% more damage and hits guaranteed +35 damage.",50,24147,7474,7486),
    ...
    ANCIENT_GODSWORD(26233, "Blood Sacrifice: In addition to doubled accuracy, it inflicts damage with a 10% higher maximum hit than a normal attack.", 50.0, 31354, 7699, 7711),
    ...
    SHADOW_MACE(32701, "Shadow smasher: Increase damage by 35% and accuracy by 75% for one hit.", 35.0, 31406, 7624, 7636),
    ...
    CRYSTAL_PICKAXE(23680, "Rock Knocker: Increase your Mining level by 3.", 100.0, 31401, 7724, 7736),
    CRYSTAL_PICKAXE_2(CRYSTAL_PICKAXE_23863, "Rock Knocker: Increase your Mining level by 3.", 100.0, 31401, 7724, 7736),
    ...
    DRAGON_PICKAXE_OR_2(DRAGON_PICKAXE_OR_25376, "Rock Knocker: Increase your Mining level by 3.", 100.0, 31454, 7724, 7736),
