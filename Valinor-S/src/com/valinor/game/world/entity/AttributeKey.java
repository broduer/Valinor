...
public enum AttributeKey {
    ...
    INFERNAL_SPIDER_LOG_CLAIMED,
    ENRAGED_GORILLA_LOG_CLAIMED,
    CHAOTIC_NIGHTMARE_LOG_CLAIMED,
    ...
    NIGHTMARE_STAFF_QUESTION("nightmare_staff_question", AttribType.BOOLEAN),
    VORKATH_CB_COOLDOWN,
    ...
    CHAOTIC_NIGHTMARE_KILLS("chaotic_nightmare_kills", AttribType.INTEGER),
    ENRAGED_GORILLA_KILLS("enraged_gorilla_kills", AttribType.INTEGER),
