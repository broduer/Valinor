...
import com.valinor.game.world.entity.combat.formula.MagicMaxHit;
import com.valinor.game.world.entity.combat.formula.MeleeMaxHit;
import com.valinor.game.world.entity.combat.formula.RangeMaxHit;
...
import com.valinor.game.world.entity.combat.hit.HitQueue;
...
import com.valinor.game.world.entity.combat.method.impl.specials.melee.GraniteMaul;
...
public class Combat {
    ...
    /**
     * the next spell to cast example from {@link com.valinor.net.packet.incoming_packets.MagicOnPlayerPacketListener}
     */
