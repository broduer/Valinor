package com.valinor.game.world.entity.mob.npc.pets;
...
public enum Pet {
    ...
    PET_CORRUPTED_NECHRYARCH(CustomItemIdentifiers.PET_CORRUPTED_NECHRYARCH, CustomNpcIdentifiers.CORRUPTED_NECHRYARCH_PET, -1),
    ...
    WAMPA(CustomItemIdentifiers.WAMPA_PET, CustomNpcIdentifiers.WAMPA_PET, -1),
    ...
    ENRAGED_TEKTINY(ItemIdentifiers.ENRAGED_TEKTINY, NpcIdentifiers.ENRAGED_TEKTINY, NpcIdentifiers.OLMLET_7520, UNLOCK_PET_OLMLET),
    ...
    FLYING_VESPINA(ItemIdentifiers.FLYING_VESPINA, NpcIdentifiers.FLYING_VESPINA, NpcIdentifiers.OLMLET_7520, UNLOCK_PET_OLMLET),
    IKKLE_HYDRA_GREEN(ItemIdentifiers.IKKLE_HYDRA, NpcIdentifiers.IKKLE_HYDRA, NpcIdentifiers.IKKLE_HYDRA_8493,UNLOCKED_PET_ALCHY),
    IKKLE_HYDRA_BLUE(ItemIdentifiers.IKKLE_HYDRA_22748, NpcIdentifiers.IKKLE_HYDRA_8493, NpcIdentifiers.IKKLE_HYDRA_8494,UNLOCKED_PET_ALCHY),
    IKKLE_HYDRA_RED(ItemIdentifiers.IKKLE_HYDRA_22750, NpcIdentifiers.IKKLE_HYDRA_8494, NpcIdentifiers.IKKLE_HYDRA_8495,UNLOCKED_PET_ALCHY),
