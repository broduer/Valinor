...
import com.valinor.game.world.entity.mob.player.commands.impl.owner.CheckServerWealthCommand
...
object SaveWealthInfo {
    ...
    fun saveWealth(pFeedback: Player, storage: CheckServerWealthCommand.AtomicStorage) {
        ...
        str += ("The total ANCIENT FACEGUARD for all " + goal + " players is: " + Utils.formatNumber(storage.sumAncientFacegaurd.get())+"\n")
