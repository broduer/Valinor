package com.valinor.game.world.entity.mob.movement;

import com.valinor.game.content.mechanics.MultiwayCombat;
import com.valinor.game.task.Task;
import com.valinor.game.task.TaskManager;
import com.valinor.game.task.impl.MobFollowTask;
...
public final class MovementQueue {
    ...
    private void runiteProcess() {
        ...
        if (runiteStep) {
            ...
            boolean forceRun = stepType == com.valinor.game.world.route.StepType.FORCE_RUN;
            boolean ran = (forceRun || (isRunning() && stepType != com.valinor.game.world.route.StepType.FORCE_WALK)) && step(mob);
    ...
    public com.valinor.game.world.route.StepType stepType = com.valinor.game.world.route.StepType.NORMAL;

    public void reset() {
        readOffset = 0;
        writeOffset = 0;
        stepType = com.valinor.game.world.route.StepType.NORMAL;
    }
    ...
    public boolean forcedStep() {
        return stepType == com.valinor.game.world.route.StepType.FORCE_WALK ||
            stepType == com.valinor.game.world.route.StepType.FORCE_RUN;
    }
}
