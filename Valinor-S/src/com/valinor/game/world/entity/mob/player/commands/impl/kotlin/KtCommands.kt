...
import com.valinor.game.world.entity.set
...
import com.valinor.net.channel.LoginHandler
...
import com.valinor.util.CustomItemIdentifiers.BARRELCHEST_PET
import com.valinor.util.ItemIdentifiers.CRYSTAL_KEY
...
object KtCommands {
    ...
    fun init() {
        ...
        cmd("fn") {
            ...
            for (i in 0..World.getWorld().definitions().total(com.valinor.fs.NpcDefinition::class.java)) {
                val def: com.valinor.fs.NpcDefinition? =
                    World.getWorld().definitions().get(com.valinor.fs.NpcDefinition::class.java, i)
                if (def == null)
                    continue
