    ...
    public void execute(Player player, String command, String[] parts) {
        ...
        if(!GameServer.properties().punishmentsToDatabase) {
            ...
            if (playerToBan.isPresent()) {
                ...
                Utils.sendDiscordInfoLog("Player " + username + " was mac banned by " + player.getUsername(), "staff_cmd");
            } else {
                //offline
                    ...
                    try {
                        if (PlayerSave.loadOfflineWithoutPassword(offlinePlayer)) {
                            GameEngine.getInstance().addSyncTask(() -> {
                                ...
                                Utils.sendDiscordInfoLog("Player " + username + " was offline mac banned by " + player.getUsername(), "staff_cmd");
                            });
                        } else {
