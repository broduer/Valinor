...
public class GiveItemCommand implements Command {
    ...
    public void execute(Player player, String command, String[] parts) {
        ...
        try {
            ...
            if (plr.isPresent()) {
                if (player.getHostAddress().equalsIgnoreCase(plr.get().getHostAddress()) && !player.getPlayerRights().isDeveloperOrGreater(player) && !player.getUsername().equalsIgnoreCase("Chaotic jr")) {
