package com.valinor.game.world.items.container.looting_bag;
...
import static com.valinor.util.ItemIdentifiers.LOOTING_BAG;
import static com.valinor.util.ItemIdentifiers.LOOTING_BAG_22586;
...
public class LootingBag extends ItemContainer {
    ...
    public boolean deposit(Item item, int amount, GroundItem groundItem) {
        ...
        if (!WildernessArea.inWilderness(player.tile()) && !player.getMemberRights().isEmeraldMemberOrGreater(player)) {
