...
public enum Cart {
    ...
    INFINITY_HAT(ItemIdentifiers.INFINITY_HAT,25),
    INFINITY_TOP(ItemIdentifiers.INFINITY_TOP,25),
    INFINITY_BOTTOMS(ItemIdentifiers.INFINITY_BOTTOMS,25),
    INFINITY_BOOTS(ItemIdentifiers.INFINITY_BOOTS,25),
    INFINITY_GLOVES(ItemIdentifiers.INFINITY_GLOVES,25),
    MASTER_WAND(ItemIdentifiers.MASTER_WAND,25),
    MAGES_BOOK(ItemIdentifiers.MAGES_BOOK,50),
