...
public enum Cart {
    ...
    NEW_CRYSTAL_HALBERD_FULL(ItemIdentifiers.NEW_CRYSTAL_HALBERD_FULL,250),
    NEW_CRYSTAL_BOW(ItemIdentifiers.NEW_CRYSTAL_BOW,250),
    NEW_CRYSTAL_SHIELD(ItemIdentifiers.NEW_CRYSTAL_SHIELD,250),
    PEGASIAN_CRYSTAL(ItemIdentifiers.PEGASIAN_CRYSTAL,500),
    PRIMORDIAL_CRYSTAL(ItemIdentifiers.PRIMORDIAL_CRYSTAL,500),
    ETERNAL_CRYSTAL(ItemIdentifiers.ETERNAL_CRYSTAL,500),
    PEGASIAN_BOOTS(ItemIdentifiers.PEGASIAN_BOOTS,500),
    PRIMORDIAL_BOOTS(ItemIdentifiers.PRIMORDIAL_BOOTS,500),
    ETERNAL_BOOTS(ItemIdentifiers.ETERNAL_BOOTS,500),
