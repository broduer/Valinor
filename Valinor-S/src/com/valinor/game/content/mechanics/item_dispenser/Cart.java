...
public enum Cart {
    ...
    HOLY_GHRAZI_RAPIER(ItemIdentifiers.HOLY_GHRAZI_RAPIER,1500),
    HOLY_SANGUINESTI_STAFF(ItemIdentifiers.HOLY_SANGUINESTI_STAFF,1500),
    HOLY_SCYTHE_OF_VITUR(ItemIdentifiers.HOLY_SCYTHE_OF_VITUR,12000),
    SANGUINE_SCYTHE_OF_VITUR(ItemIdentifiers.SANGUINE_SCYTHE_OF_VITUR,35000),
