package com.valinor.game.content.mechanics.promo;
...
public class PaymentPromo {
    ...
    private enum PromoItems {
        ...
        SECOND_PROMO_UNLOCK(27416, 27412, new Item(CustomItemIdentifiers.DONATOR_TICKET,1000), 334, 100),
        THIRD_PROMO_UNLOCK(27417, 27413, new Item(CustomItemIdentifiers.TOXIC_STAFF_OF_THE_DEAD_C), 335, 250),
        FOURTH_PROMO_UNLOCK(27418, 27414, new Item(CustomItemIdentifiers.MAGMA_BLOWPIPE), 336, 500),
        FIFTH_PROMO_UNLOCK(27415, 27411, new Item(CustomItemIdentifiers.KEY_OF_DROPS), 333, 1000),
        SIXTH_PROMO_UNLOCK(27416, 27412, new Item(ItemIdentifiers.CHRISTMAS_CRACKER), 334, 1500),
        SEVENTH_PROMO_UNLOCK(27417, 27413, new Item(CustomItemIdentifiers.VALINOR_COINS,10_000), 335, 2000),
        EIGHTH_PROMO_UNLOCK(27418, 27414, new Item(CustomItemIdentifiers.ANCIENT_WARRIOR_CLAMP), 336, 2500),
