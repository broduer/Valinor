...
public enum Collection {
    ...
    */
    ...
    KRAKEN(AttributeKey.KRAKENS_KILLED, LogType.BOSSES, "Kraken", new int[]{NpcIdentifiers.KRAKEN}, AttributeKey.KRAKEN_LOG_CLAIMED, new Item[]{new Item(CustomItemIdentifiers.SUPER_MYSTERY_BOX, 3), new Item(KEY_OF_DROPS)},
        //Drops
    ...
    VORKATH(AttributeKey.VORKATHS_KILLED, LogType.BOSSES, "Vorkath", new int[]{NpcIdentifiers.VORKATH}, AttributeKey.VORKATH_LOG_CLAIMED, new Item[]{new Item(CustomItemIdentifiers.MYSTERY_CHEST, 1), new Item(CustomItemIdentifiers.SUPER_MYSTERY_BOX, 2), new Item(DIAMOND_DRAGON_BOLTS_E, 5000)},
        //Drops
    ...
    ZULRAH(AttributeKey.ZULRAHS_KILLED, LogType.BOSSES, "Zulrah", new int[]{NpcIdentifiers.ZULRAH, NpcIdentifiers.ZULRAH_2044, NpcIdentifiers.ZULRAH_2043}, AttributeKey.ZULRAH_LOG_CLAIMED, new Item[]{new Item(CustomItemIdentifiers.MYSTERY_CHEST), new Item(CustomItemIdentifiers.MYSTERY_TICKET,2), new Item(MAGMA_BLOWPIPE, 1)},
        //Drops
    ...
    THE_NIGHTMARE(AttributeKey.THE_NIGHTMARE_KC, LogType.BOSSES, "The nightmare", new int[]{THE_NIGHTMARE_9430}, AttributeKey.THE_NIGTHMARE_LOG_CLAIMED, new Item[]{new Item(CustomItemIdentifiers.MYSTERY_CHEST, 3), new Item(CustomItemIdentifiers.MYSTERY_TICKET,3), new Item(COINS_995, 500_000_000), new Item(WRATH_RUNE,10_000)},
        //Drops
    ...
    CHAMBER_OF_XERIC(AttributeKey.CHAMBER_OF_SECRET_RUNS_COMPLETED, LogType.BOSSES, "Chambers of Xeric", new int[]{COX_RAIDS_KEY}, AttributeKey.CHAMBER_OF_SECRETS_LOG_CLAIMED, new Item[]{new Item(CustomItemIdentifiers.SUPER_MYSTERY_BOX,5), new Item(CustomItemIdentifiers.MYSTERY_CHEST, 2), new Item(CustomItemIdentifiers.RAIDS_MYSTERY_BOX,5)},
        //Drops
    ...
    //Mystery chest
    MYSTERY_CHEST(AttributeKey.MYSTERY_CHESTS_OPENED, LogType.MYSTERY_BOX, "Mystery Chest", new int[]{CustomItemIdentifiers.MYSTERY_CHEST}, AttributeKey.MYSTERY_CHEST_LOG_CLAIMED, new Item[]{new Item(CustomItemIdentifiers.MYSTERY_CHEST, 2), new Item(CustomItemIdentifiers.SUPER_MYSTERY_BOX)},
        //Drops
    ...
    //Pets mystery box
    PETS_MYSTERY_BOX(AttributeKey.PETS_MYSTERY_BOXES_OPENED, LogType.MYSTERY_BOX, "Pets Mystery Box", new int[]{CustomItemIdentifiers.PETS_MYSTERY_BOX}, AttributeKey.MYSTERY_CHEST_LOG_CLAIMED, new Item[]{new Item(CustomItemIdentifiers.PETS_MYSTERY_BOX, 2), new Item(CustomItemIdentifiers.SUPER_MYSTERY_BOX)},
        //Drops
