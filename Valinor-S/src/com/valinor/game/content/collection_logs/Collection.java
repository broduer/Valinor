...
public enum Collection {
    ...
    BRYOPHYTA(AttributeKey.KC_BRYOPHYTA, LogType.BOSSES, "Bryophyta", new int[]{NpcIdentifiers.BRYOPHYTA}, AttributeKey.BRYOPHYTA_LOG_CLAIMED, new Item[]{new Item(CustomItemIdentifiers.DONATOR_MYSTERY_BOX, 3)},
        //Drops
    ...
    CHAOS_ELEMENTAL(AttributeKey.CHAOS_ELEMENTALS_KILLED, LogType.BOSSES, "Chaos Elemental", new int[]{NpcIdentifiers.CHAOS_ELEMENTAL}, AttributeKey.CHAOS_ELEMENTAL_LOG_CLAIMED, new Item[]{new Item(CustomItemIdentifiers.DONATOR_MYSTERY_BOX)},
        //Drops
    ...
    CORPOREAL_BEAST(AttributeKey.CORPOREAL_BEASTS_KILLED, LogType.BOSSES, "Corporeal Beast", new int[]{NpcIdentifiers.CORPOREAL_BEAST}, AttributeKey.CORPOREAL_BEAST_LOG_CLAIMED, new Item[]{new Item(CustomItemIdentifiers.DONATOR_MYSTERY_BOX, 3), new Item(CustomItemIdentifiers.DONATOR_MYSTERY_BOX, 2)},
        //Drops
    ...
    DAGANNOTH_KINGS(null, LogType.BOSSES, "Dagannoth Kings", new int[]{NpcIdentifiers.DAGANNOTH_REX, NpcIdentifiers.DAGANNOTH_PRIME, NpcIdentifiers.DAGANNOTH_SUPREME}, AttributeKey.DAGANNOTH_KINGS_LOG_CLAIMED, new Item[]{new Item(CustomItemIdentifiers.DONATOR_MYSTERY_BOX, 3), new Item(CustomItemIdentifiers.DONATOR_MYSTERY_BOX, 2)},
        //Drops
    ...
    GENERAL_GRAARDOR(AttributeKey.GENERAL_GRAARDOR_KILLED, LogType.BOSSES, "General Graardor", new int[]{NpcIdentifiers.GENERAL_GRAARDOR}, AttributeKey.GENERAL_GRAARDOR_LOG_CLAIMED, new Item[]{new Item(CustomItemIdentifiers.DONATOR_MYSTERY_BOX, 3), new Item(CustomItemIdentifiers.DONATOR_MYSTERY_BOX, 2)},
        //Drops
    ...
    GROTESQUE_GUARDIANS(AttributeKey.GROTESQUE_GUARDIANS, LogType.BOSSES, "Grotesque Guardians", new int[]{NpcIdentifiers.DUSK, NpcIdentifiers.DAWN},  AttributeKey.GROTESQUE_GUARDIANS_LOG_CLAIMED, new Item[]{new Item(DRAGON_CLAWS)},
        //Drops
    ...
    KRIL_TSUTSAROTH(AttributeKey.KRIL_TSUTSAROTHS_KILLED, LogType.BOSSES, "K'ril Tsutsaroth", new int[]{NpcIdentifiers.KRIL_TSUTSAROTH}, AttributeKey.KRIL_TSUTSAROTH_LOG_CLAIMED, new Item[]{new Item(DRAGON_CLAWS)},
        //Drops
    ...
    KALPHITE_QUEEN(AttributeKey.KC_KQ, LogType.BOSSES, "Kalphite Queen", new int[]{NpcIdentifiers.KALPHITE_QUEEN_6501}, AttributeKey.KALPHITE_QUEEN_LOG_CLAIMED, new Item[]{new Item(DRAGON_CLAWS)},
        //Drops
        new Item(KALPHITE_PRINCESS), new Item(KQ_HEAD), new Item(JAR_OF_SAND), new Item(DRAGON_2H_SWORD), new Item(DRAGON_CHAINBODY)),

    KING_BLACK_DRAGON(AttributeKey.KING_BLACK_DRAGONS_KILLED, LogType.BOSSES, "King Black Dragon", new int[]{NpcIdentifiers.KING_BLACK_DRAGON}, AttributeKey.KING_BLACK_DRAGON_LOG_CLAIMED, new Item[]{new Item(CustomItemIdentifiers.DONATOR_MYSTERY_BOX, 3), new Item(DRAGONFIRE_SHIELD, 2)},
        //Drops
    ...
    KREEARRA(AttributeKey.KREE_ARRA_KILLED, LogType.BOSSES, "Kree'Arra", new int[]{NpcIdentifiers.KREEARRA}, AttributeKey.KREEARRA_LOG_CLAIMED, new Item[]{new Item(ANCIENT_WYVERN_SHIELD), new Item(DRAGONFIRE_WARD)},
        //Drops
    ...
    SKOTIZO(AttributeKey.SKOTIZOS_KILLED, LogType.BOSSES, "Skotizo", new int[]{NpcIdentifiers.SKOTIZO}, AttributeKey.SKOTIZO_LOG_CLAIMED, new Item[]{new Item(CustomItemIdentifiers.DONATOR_MYSTERY_BOX, 3)},
        //Drops
    ...
    // Custom bosses
    BARRELCHEST(AttributeKey.BARRELCHESTS_KILLED, LogType.BOSSES, "Barrelchests", new int[]{NpcIdentifiers.BARRELCHEST_6342}, AttributeKey.BARRELCHEST_LOG_CLAIMED, new Item[]{new Item(CustomItemIdentifiers.DONATOR_MYSTERY_BOX)},
        //Drops
