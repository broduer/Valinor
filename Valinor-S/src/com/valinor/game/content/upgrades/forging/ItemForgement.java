...
public enum ItemForgement {
    ...
    HOLY_SCYHTE_OF_VITUR("Holy scythe of vitur", ItemForgingCategory.WEAPON, 50, new Item(HOLY_SCYTHE_OF_VITUR), new Item(SCYTHE_OF_VITUR,1), AttributeKey.HOLY_SCYTHE_OF_VITUR_ATTEMPTS),
    ...
    SANGUINE_SCYTHE_OF_VITUR("Sanguine scythe of vitur", ItemForgingCategory.WEAPON, 25, new Item(ItemIdentifiers.SANGUINE_SCYTHE_OF_VITUR), new Item(ItemIdentifiers.SCYTHE_OF_VITUR,1), AttributeKey.SANGUINE_SCYTHE_OF_VITUR_ATTEMPTS),
    VIGGORAS_CHAINMACE_C("Viggora's chainmace (c)", ItemForgingCategory.WEAPON, 25, new Item(CustomItemIdentifiers.VIGGORAS_CHAINMACE_C), new Item(VIGGORAS_CHAINMACE, 1), AttributeKey.CORRUPTED_VIGGORAS_CHAINMACE_ATTEMPTS),
    CRAWS_BOW_C("Craw's bow (c)", ItemForgingCategory.WEAPON, 25, new Item(CustomItemIdentifiers.CRAWS_BOW_C), new Item(CRAWS_BOW, 1), AttributeKey.CORRUPTED_CRAWS_BOW_ATTEMPTS),
    THAMMARONS_SCEPTRE_C("Thammaron's sceptre (c)", ItemForgingCategory.WEAPON, 25, new Item(CustomItemIdentifiers.THAMMARONS_STAFF_C), new Item(THAMMARONS_SCEPTRE,1), AttributeKey.CORRUPTED_THAMMARONS_STAFF_ATTEMPTS),
    SANGUINE_TWISTED_BOW("Sanguine twisted bow", ItemForgingCategory.WEAPON, 20, new Item(CustomItemIdentifiers.SANGUINE_TWISTED_BOW), new Item(ItemIdentifiers.TWISTED_BOW, 1), AttributeKey.SANGUINE_TWISTED_BOW_ATTEMTPS),
    TOXIC_STAFF_C("Toxic staff of the dead (c)", ItemForgingCategory.WEAPON, 25, new Item(TOXIC_STAFF_OF_THE_DEAD_C), new Item(TOXIC_STAFF_OF_THE_DEAD,1), AttributeKey.TOXIC_STAFF_OF_THE_DEAD_C_ATTEMPTS),
    ...
    AMULET_OF_TORTURE("Amulet of torture (or)", ItemForgingCategory.ARMOUR, 25, new Item(AMULET_OF_TORTURE_OR), new Item(ItemIdentifiers.AMULET_OF_TORTURE, 1), AttributeKey.TORTURE_OR_ATTEMPTS),
    NECKLACE_OF_ANGUISH("Necklace of anguish (or)", ItemForgingCategory.ARMOUR, 25, new Item(NECKLACE_OF_ANGUISH_OR), new Item(ItemIdentifiers.NECKLACE_OF_ANGUISH, 1), AttributeKey.ANGUISH_OR_ATTEMPTS),
    ...
    TORMENTED_BRACELET("Tormented bracelet (or)", ItemForgingCategory.ARMOUR, 25, new Item(TORMENTED_BRACELET_OR), new Item(ItemIdentifiers.TORMENTED_BRACELET, 1), AttributeKey.TORMENTED_BRACELET_OR_ATTEMPTS),
    ANCESTRAL_HAT_I("Ancestral hat (i)", ItemForgingCategory.ARMOUR, 50, new Item(CustomItemIdentifiers.ANCESTRAL_HAT_I), new Item(ANCESTRAL_HAT, 1), AttributeKey.ANCESTRAL_HAT_I_ATTEMPTS),
    ANCESTRAL_ROBE_TOP_I("Ancestral robe top (i)", ItemForgingCategory.ARMOUR, 40, new Item(CustomItemIdentifiers.ANCESTRAL_ROBE_TOP_I), new Item(ANCESTRAL_ROBE_TOP, 1), AttributeKey.ANCESTRAL_ROBE_TOP_I_ATTEMPTS),
    ANCESTRAL_ROBE_BOTTOM_I("Ancestral robe bottom (i)", ItemForgingCategory.ARMOUR, 40, new Item(CustomItemIdentifiers.ANCESTRAL_ROBE_BOTTOM_I), new Item(ANCESTRAL_ROBE_BOTTOM, 1), AttributeKey.ANCESTRAL_ROBE_BOTTOM_I_ATTEMPTS),
    PRIMORDIAL_BOOTS_OR("Primordial boots (or)", ItemForgingCategory.ARMOUR, 25, new Item(CustomItemIdentifiers.PRIMORDIAL_BOOTS_OR), new Item(PRIMORDIAL_BOOTS, 1), AttributeKey.PRIMORDIAL_BOOTS_OR_ATTEMPTS),
    PEGASIAN_BOOTS_OR("Pegasian boots (or)", ItemForgingCategory.ARMOUR, 25, new Item(CustomItemIdentifiers.PEGASIAN_BOOTS_OR), new Item(PEGASIAN_BOOTS, 1), AttributeKey.PEGASIAN_BOOTS_OR_ATTEMPTS),
    ETERNAL_BOOTS_OR("Eternal boots (or)", ItemForgingCategory.ARMOUR, 25, new Item(CustomItemIdentifiers.ETERNAL_BOOTS_OR), new Item(ETERNAL_BOOTS, 1), AttributeKey.ETERNAL_BOOTS_OR_ATTEMPTS),
    ANCIENT_FACEGUARD("Ancient faceguard", ItemForgingCategory.ARMOUR, 25, new Item(CustomItemIdentifiers.ANCIENT_FACEGAURD), new Item(NEITIZNOT_FACEGUARD,1), AttributeKey.ANCIENT_FACEGUARD_ATTEMPTS),
