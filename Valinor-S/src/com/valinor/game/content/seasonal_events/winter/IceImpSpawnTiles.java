 ...
 */
public class IceImpSpawnTiles {

    public static final List<Tile> lumbridgeSpawns = Arrays.asList(
    ...
    public static final List<Tile> draynorSpawns = Arrays.asList(
    ...
    public static final List<Tile> varrockSpawns = Arrays.asList(
    ...
    public static final List<Tile> faladorSpawns = Arrays.asList(
    ...
    public static final List<Tile> wildernessSpawns = Arrays.asList(
