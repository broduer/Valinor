...
public class ElderWand extends PacketInteraction {
    ...
    public static final int CRUCIATUS_CURSE_SPELL_BASE_MAX_HIT = 55;//The curse inflicts intense, excruciating pain on the victim.
    public static final int PETRIFICUS_TOTALUS_SPELL_BASE_MAX_HIT = 55;//Binding spell, 10 seconds.
    public static final int EXPELLIARMUS_SPELL_BASE_MAX_HIT = 55;//Disarming spell.
    public static final int SECTUMSEMPRA_SPELL_BASE_MAX_HIT = 55;//Spell dealing small cuts.
