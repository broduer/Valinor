...
public class ItemCombining extends Interaction {
    ...
    private enum Combine {
        ...
        AGS(ARMADYL_GODSWORD_OR, ARMADYL_GODSWORD, ARMADYL_GODSWORD_ORNAMENT_KIT, false),

        BGS(BANDOS_GODSWORD_OR, BANDOS_GODSWORD, BANDOS_GODSWORD_ORNAMENT_KIT, false),

        SGS(SARADOMIN_GODSWORD_OR, SARADOMIN_GODSWORD, SARADOMIN_GODSWORD_ORNAMENT_KIT, false),

        ZGS(ZAMORAK_GODSWORD_OR, ZAMORAK_GODSWORD, ZAMORAK_GODSWORD_ORNAMENT_KIT, false),

        TORTURE(AMULET_OF_TORTURE_OR, AMULET_OF_TORTURE, TORTURE_ORNAMENT_KIT, false),

        DSCIM(DRAGON_SCIMITAR_OR, DRAGON_SCIMITAR, DRAGON_SCIMITAR_ORNAMENT_KIT, true),

        FURY(AMULET_OF_FURY_OR, AMULET_OF_FURY, FURY_ORNAMENT_KIT, false),

        OCCULT(OCCULT_NECKLACE_OR, OCCULT_NECKLACE, OCCULT_ORNAMENT_KIT, false),

        GRANITE_CLAMP(GRANITE_MAUL_12848, GRANITE_MAUL_24225, ItemIdentifiers.GRANITE_CLAMP, false),
        ...
        FROZEN_WHIP(FROZEN_ABYSSAL_WHIP, ABYSSAL_WHIP, FROZEN_WHIP_MIX, false),

        VOLCANIC_WHIP(VOLCANIC_ABYSSAL_WHIP, ABYSSAL_WHIP, VOLCANIC_WHIP_MIX, false),

        BLUE_DARKBOW(DARK_BOW_12765, DARK_BOW, BLUE_DARK_BOW_PAINT, false),

        GREEN_DARKBOW(DARK_BOW_12766, DARK_BOW, GREEN_DARK_BOW_PAINT, false),

        YELLOW_DARKBOW(DARK_BOW_12767, DARK_BOW, YELLOW_DARK_BOW_PAINT, false),

        WHITE_DARKBOW(DARK_BOW_12768, DARK_BOW, WHITE_DARK_BOW_PAINT, false),
        ...
        DRAGON_BOOTS(DRAGON_BOOTS_G, ItemIdentifiers.DRAGON_BOOTS, DRAGON_BOOTS_ORNAMENT_KIT, false),

        ANGUISH(NECKLACE_OF_ANGUISH_OR, NECKLACE_OF_ANGUISH, ANGUISH_ORNAMENT_KIT, false),
        ...
        DRAGON_DEFENDER_T(ItemIdentifiers.DRAGON_DEFENDER_T, ItemIdentifiers.DRAGON_DEFENDER, DRAGON_DEFENDER_ORNAMENT_KIT, false),

        TZHAAR_KET_OM_T(TZHAARKETOM_T, TZHAARKETOM, TZHAARKETOM_ORNAMENT_KIT, true),

        BERSERKER_NECKLACE_OR(ItemIdentifiers.BERSERKER_NECKLACE_OR, BERSERKER_NECKLACE, BERSERKER_NECKLACE_ORNAMENT_KIT, false),

        TORMENTED_BRACELET_OR(ItemIdentifiers.TORMENTED_BRACELET_OR, TORMENTED_BRACELET, TORMENTED_ORNAMENT_KIT, false),
        ...
        HOLY_GHRAZI_RAPIER(ItemIdentifiers.HOLY_GHRAZI_RAPIER, GHRAZI_RAPIER, HOLY_ORNAMENT_KIT, false, true),

        HOLY_SANGUINESTI_STAFF(ItemIdentifiers.HOLY_SANGUINESTI_STAFF, SANGUINESTI_STAFF, HOLY_ORNAMENT_KIT, false, true),

        HOLY_SCYTHE_OF_VITUR(ItemIdentifiers.HOLY_SCYTHE_OF_VITUR, SCYTHE_OF_VITUR, HOLY_ORNAMENT_KIT, false, true),

        SANGUINE_SCYTHE_OF_VITUR(ItemIdentifiers.SANGUINE_SCYTHE_OF_VITUR, SCYTHE_OF_VITUR, SANGUINE_ORNAMENT_KIT, false),

        SANGUINE_TWISTED_BOW(CustomItemIdentifiers.SANGUINE_TWISTED_BOW, TWISTED_BOW, SANGUINE_ORNAMENT_KIT, false),
        ...
        CRYSTAL_OF_IORWERTH_CROWN(CRYSTAL_CROWN_23913, CRYSTAL_CROWN, CRYSTAL_OF_IORWERTH, false, true),

        CRYSTAL_OF_IORWERTH_BLADE(BLADE_OF_SAELDOR_C_25872, BLADE_OF_SAELDOR_C, CRYSTAL_OF_IORWERTH, false, true),

        CRYSTAL_OF_IORWERTH_BOW(BOW_OF_FAERDHINEN_C_25886, BOW_OF_FAERDHINEN_C_25884, CRYSTAL_OF_IORWERTH, false, true),

        CRYSTAL_OF_TRAHAEARN_CROWN(ItemIdentifiers.CRYSTAL_CROWN_23915, CRYSTAL_CROWN, CRYSTAL_OF_TRAHAEARN, false, true),

        CRYSTAL_OF_TRAHAEARN_BLADE(ItemIdentifiers.BLADE_OF_SAELDOR_C_25874, BLADE_OF_SAELDOR_C, CRYSTAL_OF_TRAHAEARN, false, true),

        CRYSTAL_OF_TRAHAEARN_BOW(ItemIdentifiers.BOW_OF_FAERDHINEN_C_25888, BOW_OF_FAERDHINEN_C_25884, CRYSTAL_OF_TRAHAEARN, false, true),

        CRYSTAL_OF_CADARN_CROWN(ItemIdentifiers.CRYSTAL_CROWN_23917, CRYSTAL_CROWN, CRYSTAL_OF_CADARN, false, true),

        CRYSTAL_OF_CADARN_BLADE(ItemIdentifiers.BLADE_OF_SAELDOR_C_25876, BLADE_OF_SAELDOR_C, CRYSTAL_OF_CADARN, false, true),

        CRYSTAL_OF_CADARN_BOW(ItemIdentifiers.BOW_OF_FAERDHINEN_C_25890, BOW_OF_FAERDHINEN_C_25884, CRYSTAL_OF_CADARN, false, true),

        CRYSTAL_OF_CRWYS_CROWN(ItemIdentifiers.CRYSTAL_CROWN_23919, CRYSTAL_CROWN, CRYSTAL_OF_CRWYS, false, true),

        CRYSTAL_OF_CRWYS_BLADE(ItemIdentifiers.BLADE_OF_SAELDOR_C_25878, BLADE_OF_SAELDOR_C, CRYSTAL_OF_CRWYS, false, true),

        CRYSTAL_OF_CRWYS_BOW(ItemIdentifiers.BOW_OF_FAERDHINEN_C_25892, BOW_OF_FAERDHINEN_C_25884, CRYSTAL_OF_CRWYS, false, true),

        CRYSTAL_OF_MEILYR_CROWN(ItemIdentifiers.CRYSTAL_CROWN_23921, CRYSTAL_CROWN, CRYSTAL_OF_MEILYR, false, true),

        CRYSTAL_OF_MEILYR_BLADE(ItemIdentifiers.BLADE_OF_SAELDOR_C_25880, BLADE_OF_SAELDOR_C, CRYSTAL_OF_MEILYR, false, true),

        CRYSTAL_OF_MEILYR_BOW(ItemIdentifiers.BOW_OF_FAERDHINEN_C_25894, BOW_OF_FAERDHINEN_C_25884, CRYSTAL_OF_MEILYR, false, true),

        CRYSTAL_OF_HEFIN_CROWN(ItemIdentifiers.CRYSTAL_CROWN_23923, CRYSTAL_CROWN, CRYSTAL_OF_HEFIN, false, true),

        CRYSTAL_OF_HEFIN_BLADE(ItemIdentifiers.BLADE_OF_SAELDOR_C, BLADE_OF_SAELDOR_C, CRYSTAL_OF_HEFIN, false, true),

        CRYSTAL_OF_HEFIN_BOW(ItemIdentifiers.BOW_OF_FAERDHINEN_C, BOW_OF_FAERDHINEN_C_25884, CRYSTAL_OF_HEFIN, false, true),

        CRYSTAL_OF_AMLODD_CROWN(ItemIdentifiers.CRYSTAL_CROWN_23925, CRYSTAL_CROWN, CRYSTAL_OF_AMLODD, false, true),

        CRYSTAL_OF_AMLODD_BLADE(ItemIdentifiers.BLADE_OF_SAELDOR_C_25882, BLADE_OF_SAELDOR_C, CRYSTAL_OF_AMLODD, false, true),

        CRYSTAL_OF_AMLODDL_BOW(BOW_OF_FAERDHINEN_C_25896, BOW_OF_FAERDHINEN_C_25884, CRYSTAL_OF_AMLODD, false, true),
                    ...
                    if (combine.revert) {
                        player.getDialogueManager().start(new Dialogue() {
                            ...
                            protected void start(Object... parameters) {
                                send(DialogueType.ITEM_STATEMENT, new Item(combine.result), "<col=7f0000>Warning!</col>", "When converting this item you will keep the attachment.");
                                setPhase(0);
                            }
