...
public class ItemCombining extends Interaction {
    ...
    private enum Combine {
        ...
        BLOOD_FURY(AMULET_OF_BLOOD_FURY, AMULET_OF_FURY, BLOOD_SHARD),

        KODAI_WAND(ItemIdentifiers.KODAI_WAND, KODAI_INSIGNIA, MASTER_WAND),

        DRAG_CHAIN_G(DRAGON_CHAINBODY_G, DRAGON_CHAINBODY_3140, DRAGON_CHAINBODY_ORNAMENT_KIT),

        DRAG_LEGS_G(DRAGON_PLATELEGS_G, DRAGON_PLATELEGS, DRAGON_LEGSSKIRT_ORNAMENT_KIT),

        DRAG_SKIRT_G(DRAGON_PLATESKIRT_G, DRAGON_PLATESKIRT, DRAGON_LEGSSKIRT_ORNAMENT_KIT),

        DRAG_FULLHELM_G(DRAGON_FULL_HELM_G, DRAGON_FULL_HELM, DRAGON_FULL_HELM_ORNAMENT_KIT),

        DRAG_SQ_G(DRAGON_SQ_SHIELD_G, DRAGON_SQ_SHIELD, DRAGON_SQ_SHIELD_ORNAMENT_KIT),

        AGS(ARMADYL_GODSWORD_OR, ARMADYL_GODSWORD, ARMADYL_GODSWORD_ORNAMENT_KIT),

        BGS(BANDOS_GODSWORD_OR, BANDOS_GODSWORD, BANDOS_GODSWORD_ORNAMENT_KIT),

        SGS(SARADOMIN_GODSWORD_OR, SARADOMIN_GODSWORD, SARADOMIN_GODSWORD_ORNAMENT_KIT),

        ZGS(ZAMORAK_GODSWORD_OR, ZAMORAK_GODSWORD, ZAMORAK_GODSWORD_ORNAMENT_KIT),

        TORTURE(AMULET_OF_TORTURE_OR, AMULET_OF_TORTURE, TORTURE_ORNAMENT_KIT),

        DSCIM(DRAGON_SCIMITAR_OR, DRAGON_SCIMITAR, DRAGON_SCIMITAR_ORNAMENT_KIT),

        FURY(AMULET_OF_FURY_OR, AMULET_OF_FURY, FURY_ORNAMENT_KIT),

        OCCULT(OCCULT_NECKLACE_OR, OCCULT_NECKLACE, OCCULT_ORNAMENT_KIT),
        ...
        FROZEN_WHIP(FROZEN_ABYSSAL_WHIP, ABYSSAL_WHIP, FROZEN_WHIP_MIX),

        VOLCANIC_WHIP(VOLCANIC_ABYSSAL_WHIP, ABYSSAL_WHIP, VOLCANIC_WHIP_MIX),

        BLUE_DARKBOW(DARK_BOW_12765, DARK_BOW, BLUE_DARK_BOW_PAINT),

        GREEN_DARKBOW(DARK_BOW_12766, DARK_BOW, GREEN_DARK_BOW_PAINT),

        YELLOW_DARKBOW(DARK_BOW_12767, DARK_BOW, YELLOW_DARK_BOW_PAINT),

        WHITE_DARKBOW(DARK_BOW_12768, DARK_BOW, WHITE_DARK_BOW_PAINT),

        LIGHT_INFINITY_HAT(ItemIdentifiers.LIGHT_INFINITY_HAT, INFINITY_HAT, LIGHT_INFINITY_COLOUR_KIT),

        LIGHT_INFINITY_TOP(ItemIdentifiers.LIGHT_INFINITY_TOP, INFINITY_TOP, LIGHT_INFINITY_COLOUR_KIT),

        LIGHT_INFINITY_SKIRT(ItemIdentifiers.LIGHT_INFINITY_BOTTOMS, INFINITY_BOTTOMS, LIGHT_INFINITY_COLOUR_KIT),

        DARK_INFINITY_HAT(ItemIdentifiers.DARK_INFINITY_HAT, INFINITY_HAT, DARK_INFINITY_COLOUR_KIT),

        DARK_INFINITY_TOP(ItemIdentifiers.DARK_INFINITY_TOP, INFINITY_TOP, DARK_INFINITY_COLOUR_KIT),

        DARK_INFINITY_SKIRT(DARK_INFINITY_BOTTOMS, INFINITY_BOTTOMS, DARK_INFINITY_COLOUR_KIT),
        ...
        DRAGON_PLATEBODY(DRAGON_PLATEBODY_G, ItemIdentifiers.DRAGON_PLATEBODY, DRAGON_PLATEBODY_ORNAMENT_KIT),

        DRAGON_KITESHIELD(DRAGON_KITESHIELD_G, ItemIdentifiers.DRAGON_KITESHIELD, DRAGON_KITESHIELD_ORNAMENT_KIT),

        DRAGON_BOOTS(DRAGON_BOOTS_G, ItemIdentifiers.DRAGON_BOOTS, DRAGON_BOOTS_ORNAMENT_KIT),

        ANGUISH(NECKLACE_OF_ANGUISH_OR, NECKLACE_OF_ANGUISH, ANGUISH_ORNAMENT_KIT),

        STAFF_OF_LIGHT(ItemIdentifiers.STAFF_OF_LIGHT, STAFF_OF_THE_DEAD,SARADOMINS_LIGHT),

        R_SCIM_GUTHIX(RUNE_SCIMITAR_23330, RUNE_SCIMITAR, RUNE_SCIMITAR_ORNAMENT_KIT_GUTHIX),

        R_SCIM_SARADOMIN(RUNE_SCIMITAR_23332, RUNE_SCIMITAR, RUNE_SCIMITAR_ORNAMENT_KIT_SARADOMIN),

        R_SCIM_ZAMORAK(RUNE_SCIMITAR_23334, RUNE_SCIMITAR, RUNE_SCIMITAR_ORNAMENT_KIT_ZAMORAK),

        RUNE_DEFENDER_T(ItemIdentifiers.RUNE_DEFENDER_T, RUNE_DEFENDER, RUNE_DEFENDER_ORNAMENT_KIT),

        DRAGON_DEFENDER_T(ItemIdentifiers.DRAGON_DEFENDER_T, ItemIdentifiers.DRAGON_DEFENDER, DRAGON_DEFENDER_ORNAMENT_KIT),

        TZHAAR_KET_OM_T(TZHAARKETOM_T, TZHAARKETOM, TZHAARKETOM_ORNAMENT_KIT),

        BERSERKER_NECKLACE_OR(ItemIdentifiers.BERSERKER_NECKLACE_OR, BERSERKER_NECKLACE, BERSERKER_NECKLACE_ORNAMENT_KIT),

        TORMENTED_BRACELET_OR(ItemIdentifiers.TORMENTED_BRACELET_OR, TORMENTED_BRACELET, TORMENTED_ORNAMENT_KIT),

        TWISTED_ANCESTRAL_HAT(ItemIdentifiers.TWISTED_ANCESTRAL_HAT, ANCESTRAL_HAT, TWISTED_ANCESTRAL_COLOUR_KIT),

        TWISTED_ANCESTRAL_ROBE_TOP(ItemIdentifiers.TWISTED_ANCESTRAL_ROBE_TOP, ANCESTRAL_ROBE_TOP, TWISTED_ANCESTRAL_COLOUR_KIT),

        TWISTED_ANCESTRAL_ROBE_BOTTOM(ItemIdentifiers.TWISTED_ANCESTRAL_ROBE_BOTTOM, ANCESTRAL_ROBE_BOTTOM, TWISTED_ANCESTRAL_COLOUR_KIT),

        HOLY_GHRAZI_RAPIER(ItemIdentifiers.HOLY_GHRAZI_RAPIER, GHRAZI_RAPIER, HOLY_ORNAMENT_KIT),

        HOLY_SANGUINESTI_STAFF(ItemIdentifiers.HOLY_SANGUINESTI_STAFF, SANGUINESTI_STAFF, HOLY_ORNAMENT_KIT),

        HOLY_SCYTHE_OF_VITUR(ItemIdentifiers.HOLY_SCYTHE_OF_VITUR, SCYTHE_OF_VITUR, HOLY_ORNAMENT_KIT),
        ...
        DRAGON_AXE_TRAILBLAZER(DRAGON_AXE_OR, DRAGON_AXE, TRAILBLAZER_TOOL_ORNAMENT_KIT),

        INFERNAL_AXE_TRAILBLAZER(INFERNAL_AXE_OR, INFERNAL_AXE, TRAILBLAZER_TOOL_ORNAMENT_KIT),

        DRAGON_HARPOON_TRAILBLAZER(DRAGON_HARPOON_OR, DRAGON_HARPOON, TRAILBLAZER_TOOL_ORNAMENT_KIT),

        INFERNAL_HARPOON_TRAILBLAZER(INFERNAL_HARPOON_OR, INFERNAL_HARPOON, TRAILBLAZER_TOOL_ORNAMENT_KIT),

        DRAGON_PICKAXE_TRAILBLAZER(DRAGON_PICKAXE_OR_25376, ItemIdentifiers.DRAGON_PICKAXE, TRAILBLAZER_TOOL_ORNAMENT_KIT),

        INFERNAL_PICKAXE_TRAILBLAZER(INFERNAL_PICKAXE_OR, INFERNAL_PICKAXE, TRAILBLAZER_TOOL_ORNAMENT_KIT),

        DRAGON_PICKAXE_ZALCANO(DRAGON_PICKAXE_OR, ItemIdentifiers.DRAGON_PICKAXE, ZALCANO_SHARD),

        DRAGON_PICKAXE(DRAGON_PICKAXE_12797, ItemIdentifiers.DRAGON_PICKAXE, DRAGON_PICKAXE_UPGRADE_KIT, true),

        STEAM_STAFF(STEAM_BATTLESTAFF_12795, STEAM_BATTLESTAFF, STEAM_STAFF_UPGRADE_KIT),

        LAVA_STAFF(LAVA_BATTLESTAFF_21198, LAVA_BATTLESTAFF, LAVA_STAFF_UPGRADE_KIT),

        DRAGON_HUNTER_CROSSBOW_B(ItemIdentifiers.DRAGON_HUNTER_CROSSBOW_B, DRAGON_HUNTER_CROSSBOW, KBD_HEADS),

        DRAGON_HUNTER_CROSSBOW_T(ItemIdentifiers.DRAGON_HUNTER_CROSSBOW_T, DRAGON_HUNTER_CROSSBOW, VORKATHS_HEAD_21907),
