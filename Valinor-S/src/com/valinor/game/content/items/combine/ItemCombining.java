...
public class ItemCombining extends Interaction {
    ...
    private enum Combine {
        ...
        SANGUINE_SCYTHE_OF_VITUR(ItemIdentifiers.SANGUINE_SCYTHE_OF_VITUR, SCYTHE_OF_VITUR, SANGUINE_ORNAMENT_KIT, false, true),

        SANGUINE_TWISTED_BOW(CustomItemIdentifiers.SANGUINE_TWISTED_BOW, TWISTED_BOW, SANGUINE_ORNAMENT_KIT, false, true),
