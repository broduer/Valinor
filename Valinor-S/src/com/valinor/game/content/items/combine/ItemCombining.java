...
public class ItemCombining extends Interaction {
    ...
    private enum Combine {
        ...
        CRYSTAL_OF_IORWERTH_BLADE(BLADE_OF_SAELDOR_C_25872, BLADE_OF_SAELDOR_C, CRYSTAL_OF_IORWERTH, true),

        CRYSTAL_OF_IORWERTH_BOW(BOW_OF_FAERDHINEN_C_25886, BOW_OF_FAERDHINEN_C_25884, CRYSTAL_OF_IORWERTH, true),

        CRYSTAL_OF_TRAHAEARN_CROWN(ItemIdentifiers.CRYSTAL_CROWN_23915, CRYSTAL_CROWN, CRYSTAL_OF_TRAHAEARN, true),

        CRYSTAL_OF_TRAHAEARN_BLADE(ItemIdentifiers.BLADE_OF_SAELDOR_C_25874, BLADE_OF_SAELDOR_C, CRYSTAL_OF_TRAHAEARN, true),

        CRYSTAL_OF_TRAHAEARN_BOW(ItemIdentifiers.BOW_OF_FAERDHINEN_C_25888, BOW_OF_FAERDHINEN_C_25884, CRYSTAL_OF_TRAHAEARN, true),

        CRYSTAL_OF_CADARN_CROWN(ItemIdentifiers.CRYSTAL_CROWN_23917, CRYSTAL_CROWN, CRYSTAL_OF_CADARN, true),

        CRYSTAL_OF_CADARN_BLADE(ItemIdentifiers.BLADE_OF_SAELDOR_C_25876, BLADE_OF_SAELDOR_C, CRYSTAL_OF_CADARN, true),

        CRYSTAL_OF_CADARN_BOW(ItemIdentifiers.BOW_OF_FAERDHINEN_C_25890, BOW_OF_FAERDHINEN_C_25884, CRYSTAL_OF_CADARN, true),

        CRYSTAL_OF_CRWYS_CROWN(ItemIdentifiers.CRYSTAL_CROWN_23919, CRYSTAL_CROWN, CRYSTAL_OF_CRWYS, true),

        CRYSTAL_OF_CRWYS_BLADE(ItemIdentifiers.BLADE_OF_SAELDOR_C_25878, BLADE_OF_SAELDOR_C, CRYSTAL_OF_CRWYS, true),

        CRYSTAL_OF_CRWYS_BOW(ItemIdentifiers.BOW_OF_FAERDHINEN_C_25892, BOW_OF_FAERDHINEN_C_25884, CRYSTAL_OF_CRWYS, true),

        CRYSTAL_OF_MEILYR_CROWN(ItemIdentifiers.CRYSTAL_CROWN_23921, CRYSTAL_CROWN, CRYSTAL_OF_MEILYR, true),

        CRYSTAL_OF_MEILYR_BLADE(ItemIdentifiers.BLADE_OF_SAELDOR_C_25880, BLADE_OF_SAELDOR_C, CRYSTAL_OF_MEILYR, true),

        CRYSTAL_OF_MEILYR_BOW(ItemIdentifiers.BOW_OF_FAERDHINEN_C_25894, BOW_OF_FAERDHINEN_C_25884, CRYSTAL_OF_MEILYR, true),

        CRYSTAL_OF_HEFIN_CROWN(ItemIdentifiers.CRYSTAL_CROWN_23923, CRYSTAL_CROWN, CRYSTAL_OF_HEFIN, true),

        CRYSTAL_OF_HEFIN_BLADE(ItemIdentifiers.BLADE_OF_SAELDOR_C, BLADE_OF_SAELDOR_C, CRYSTAL_OF_HEFIN, true),

        CRYSTAL_OF_HEFIN_BOW(ItemIdentifiers.BOW_OF_FAERDHINEN_C, BOW_OF_FAERDHINEN_C_25884, CRYSTAL_OF_HEFIN, true),

        CRYSTAL_OF_AMLODD_CROWN(ItemIdentifiers.CRYSTAL_CROWN_23925, CRYSTAL_CROWN, CRYSTAL_OF_AMLODD, true),

        CRYSTAL_OF_AMLODD_BLADE(ItemIdentifiers.BLADE_OF_SAELDOR_C_25882, BLADE_OF_SAELDOR_C, CRYSTAL_OF_AMLODD, true),

        CRYSTAL_OF_AMLODDL_BOW(BOW_OF_FAERDHINEN_C_25896, BOW_OF_FAERDHINEN_C_25884, CRYSTAL_OF_AMLODD, true),
