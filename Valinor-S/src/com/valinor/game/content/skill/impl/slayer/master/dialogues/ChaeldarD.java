...
import com.valinor.game.content.skill.impl.slayer.master.impl.Chaeldar;
 ...
 */
public class ChaeldarD extends Dialogue {
    ...
    protected void start(Object... parameters) {
        ...
        send(DialogueType.NPC_STATEMENT, CHAELDAR, Expression.NODDING_ONE, "'Ello, and what are you after then?");
        setPhase(0);
    }
    ...
    protected void next() {
        if(isPhase(0)) {
            ...
            Chaeldar.giveTask(player);
        } else if (isPhase(5)) {
            send(DialogueType.NPC_STATEMENT, CHAELDAR, Expression.NODDING_FIVE, "I have quite a few rewards you can earn, and a wide", "variety of Slayer equipment for sale.");
            setPhase(6);
        } else if (isPhase(6)) {
