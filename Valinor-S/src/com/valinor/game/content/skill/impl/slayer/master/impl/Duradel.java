 ...
 */
public class Duradel extends PacketInteraction {
    ...
    public static void giveTask(Player player) {
        ...
        player.getDialogueManager().start(new Dialogue() {
            ...
            protected void start(Object... parameters) {
                send(DialogueType.NPC_STATEMENT, DURADEL, Expression.ANXIOUS, "Excellent, you're doing great. Your new task is to kill", ""+num+" "+Slayer.taskName(task.uid)+".");
                setPhase(0);
            }
