...
public enum SmithableEquipment {
    ...
    BRONZE_CLAWS("Claws", 2349, 3095, 1, 1120, 4, 8429, 13, 25, 2,8428),
    ...
    BRONZE_JAVELIN_HEADS("Javelin heads", 2353, ItemIdentifiers.BRONZE_JAVELIN_HEADS, 5, 1123, 3, 1096, 6, 12.5,1, 1132),
    ...
    IRON_CLAWS("Claws", 2351, 3096, 1, 1120, 4, 8429, 28, 50, 2,8428),
    ...
    IRON_JAVELIN_HEADS("Javelin heads", 2351, ItemIdentifiers.IRON_JAVELIN_HEADS, 5, 1123, 3, 1096, 21, 25,1, 1132),
    ...
    MITHRIL_JAVELIN_HEADS("Javelin heads", 2351, ItemIdentifiers.MITHRIL_JAVELIN_HEADS, 5, 1123, 3, 1096, 47, 50,1, 1132),
    ...
    ADAMANT_JAVELIN_HEADS("Javelin heads", 2361, ItemIdentifiers.ADAMANT_JAVELIN_HEADS, 5, 1123, 3, 1096, 76, 62.5,1, 1132),
    ...
    RUNE_JAVELIN_HEADS("Javelin heads", 2363, ItemIdentifiers.RUNE_JAVELIN_HEADS, 5, 1123, 3, 1096, 91, 75,1, 1132),
    ;
    ...
    public static final ImmutableSet<SmithableEquipment> RUNE_ITEMS = Sets.immutableEnumSet(RUNE_DAGGER, RUNE_AXE, RUNE_MACE, RUNE_MED_HELM, RUNE_DART_TIPS, RUNE_SWORD, RUNE_ARROWTIPS, RUNE_SCIMITAR, RUNE_LONG_SWORD,
        ...
        RUNE_CLAWS, RUNE_2_HAND_SWORD, RUNE_PLATESKIRT, RUNE_PLATELEGS, RUNE_PLATEBODY, RUNE_NAILS, RUNE_UNF_BOLTS, RUNE_JAVELIN_HEADS);
    ...
    public static final ImmutableSet<SmithableEquipment> ADAMANT_ITEMS = Sets.immutableEnumSet(ADAMANT_DAGGER, ADAMANT_AXE, ADAMANT_MACE, ADAMANT_MED_HELM, ADAMANT_DART_TIPS, ADAMANT_SWORD, ADAMANT_ARROWTIPS, ADAMANT_SCIMITAR, ADAMANT_LONG_SWORD,
        ...
        ADAMANT_CLAWS, ADAMANT_2_HAND_SWORD, ADAMANT_PLATESKIRT, ADAMANT_PLATELEGS, ADAMANT_PLATEBODY, ADAMANT_NAILS, ADAMANT_UNF_BOLTS, ADAMANT_JAVELIN_HEADS);
    ...
    public static final ImmutableSet<SmithableEquipment> MITHRIL_ITEMS = Sets.immutableEnumSet(MITHRIL_DAGGER, MITHRIL_AXE, MITHRIL_MACE, MITHRIL_MED_HELM, MITHRIL_DART_TIPS, MITHRIL_SWORD, MITHRIL_ARROWTIPS, MITHRIL_SCIMITAR, MITHRIL_LONG_SWORD,
        ...
        MITHRIL_CLAWS, MITHRIL_2_HAND_SWORD, MITHRIL_PLATESKIRT, MITHRIL_PLATELEGS, MITHRIL_PLATEBODY, MITHRIL_NAILS, MITHRIL_UNF_BOLTS, MITHRIL_JAVELIN_HEADS);
    ...
    public static final ImmutableSet<SmithableEquipment> IRON_ITEMS = Sets.immutableEnumSet(IRON_DAGGER, IRON_AXE, IRON_MACE, IRON_MED_HELM, IRON_DART_TIPS, IRON_SWORD, IRON_ARROWTIPS, IRON_SCIMITAR, IRON_LONG_SWORD,
        ...
        IRON_CLAWS, IRON_2_HAND_SWORD, IRON_PLATESKIRT, IRON_PLATELEGS, IRON_PLATEBODY, IRON_NAILS, IRON_UNF_BOLTS, IRON_JAVELIN_HEADS);
    ...
    public static final ImmutableSet<SmithableEquipment> BRONZE_ITEMS = Sets.immutableEnumSet(BRONZE_DAGGER, BRONZE_AXE, BRONZE_MACE, BRONZE_MED_HELM, BRONZE_DART_TIPS, BRONZE_SWORD, BRONZE_ARROWTIPS, BRONZE_SCIMITAR, BRONZE_LONG_SWORD,
        ...
        BRONZE_CLAWS, BRONZE_2_HAND_SWORD, BRONZE_PLATESKIRT, BRONZE_PLATELEGS, BRONZE_PLATEBODY, BRONZE_NAILS, BRONZE_UNF_BOLTS, BRONZE_JAVELIN_HEADS);
