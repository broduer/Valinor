...
import com.valinor.game.content.skill.impl.slayer.master.impl.KonarQuoMaten;
 ...
 */
public class KonarQuoMatenD extends Dialogue {
    ...
    protected void next() {
        if (isPhase(0)) {
            ...
            KonarQuoMaten.giveTask(player);
        } else if (isPhase(5)) {
            send(DialogueType.NPC_STATEMENT, KONAR_QUO_MATEN, Expression.NODDING_FIVE, "I have quite a few rewards you can earn, and a wide", "variety of Slayer equipment for sale.");
            setPhase(6);
        } else if (isPhase(6)) {
