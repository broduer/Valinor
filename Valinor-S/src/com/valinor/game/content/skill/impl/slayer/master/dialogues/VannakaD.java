...
import com.valinor.game.content.skill.impl.slayer.master.impl.Vannaka;
...
public class VannakaD extends Dialogue {
    ...
    protected void next() {
        if(isPhase(0)) {
            ...
            Vannaka.giveTask(player);
        } else if (isPhase(5)) {
            send(DialogueType.NPC_STATEMENT, VANNAKA, Expression.NODDING_FIVE, "I have quite a few rewards you can earn, and a wide", "variety of Slayer equipment for sale.");
            setPhase(6);
        } else if (isPhase(6)) {
