...
public enum SlayerCreature {
    ...
    CALLISTO(123, 1, 100,true, new Tile(3307, 3837), new Tile(3295,3839), NpcIdentifiers.CALLISTO, NpcIdentifiers.CALLISTO_6609),
    CERBERUS(124, 91, 100,true, new Tile(1292,1252), NpcIdentifiers.CERBERUS, NpcIdentifiers.CERBERUS_5863, NpcIdentifiers.CERBERUS_5866),
    CHAOS_ELEMENTAL(125, 1, 100,true, new Tile(3269, 3927), new Tile(3307,3916), NpcIdentifiers.CHAOS_ELEMENTAL, NpcIdentifiers.CHAOS_ELEMENTAL_6505, CustomNpcIdentifiers.ANCIENT_CHAOS_ELEMENTAL),
    CHAOS_FANATIC(126, 1, 85,true, new Tile(2992, 3851), new Tile(2922,3851), NpcIdentifiers.CHAOS_FANATIC),
    COMMANDER_ZILYANA(127, 1, 100,true, new Tile(2912,5267, 0), NpcIdentifiers.COMMANDER_ZILYANA),
    ...
    GENERAL_GRAARDOR(130, 1, 100,true, new Tile(2861,5354, 2), NpcIdentifiers.GENERAL_GRAARDOR),
    ...
    VETION(142, 1, 100,true, new Tile(3239, 3783), new Tile(3237,3800), NpcIdentifiers.VETION, NpcIdentifiers.VETION_REBORN),
    VORKATH(143, 1, 112,true, new Tile(2273, 4049), NpcIdentifiers.VORKATH_8061),
    ZULRAH(144, 1, 100,true, new Tile(2204,3056), NpcIdentifiers.ZULRAH, NpcIdentifiers.ZULRAH_2043, NpcIdentifiers.ZULRAH_2044),
