package com.valinor.game.content.skill.impl.slayer.slayer_task;
...
public enum SlayerCreature {
    ...
    COWS(6, 1, 3, new Tile(3258,3263), NpcIdentifiers.COW, NpcIdentifiers.COW_2791, NpcIdentifiers.COW_CALF, NpcIdentifiers.COW_2793, NpcIdentifiers.COW_CALF_2794, NpcIdentifiers.COW_2795, NpcIdentifiers.COW_5842, NpcIdentifiers.COW_6401, NpcIdentifiers.COW_CALF_2801),
    SCORPION(7, 1, 7, new Tile(3047,9779), new Tile(3232,3944), NpcIdentifiers.SCORPION, NpcIdentifiers.SCORPION_2480, NpcIdentifiers.SCORPION_3024, NpcIdentifiers.SCORPION_5242, NpcIdentifiers.SCORPIA, NpcIdentifiers.SCORPIAS_OFFSPRING),
    BATS(8, 1, 5, new Tile(3433,3517), NpcIdentifiers.BAT, NpcIdentifiers.GIANT_BAT, NpcIdentifiers.GIANT_BAT_4504, NpcIdentifiers.GIANT_BAT_6824),
    WOLF(9, 1, 20, new Tile(2838,3504), NpcIdentifiers.WOLF, NpcIdentifiers.WOLF_110, NpcIdentifiers.WOLF_116, NpcIdentifiers.WOLF_117, NpcIdentifiers.WOLF_231, NpcIdentifiers.WOLF_2490, NpcIdentifiers.WOLF_2491, NpcIdentifiers.WOLF_3912, NpcIdentifiers.BIG_WOLF_115, NpcIdentifiers.DESERT_WOLF_4650, NpcIdentifiers.DESERT_WOLF_4651, NpcIdentifiers.ICE_WOLF, NpcIdentifiers.ICE_WOLF_646, NpcIdentifiers.ICE_WOLF_647, NpcIdentifiers.ICE_WOLF_710, NpcIdentifiers.ICE_WOLF_711, NpcIdentifiers.ICE_WOLF_712, NpcIdentifiers.ICE_WOLF_713, NpcIdentifiers.ICE_WOLF_714, NpcIdentifiers.ICE_WOLF_715, NpcIdentifiers.WHITE_WOLF, NpcIdentifiers.WHITE_WOLF_108),
    ZOMBIE(10, 1, 10, new Tile(2029,5233), NpcIdentifiers.ZOMBIE, NpcIdentifiers.ZOMBIE_27, NpcIdentifiers.ZOMBIE_28, NpcIdentifiers.ZOMBIE_29, NpcIdentifiers.ZOMBIE_30, NpcIdentifiers.ZOMBIE_31, NpcIdentifiers.ZOMBIE_32, NpcIdentifiers.ZOMBIE_33, NpcIdentifiers.ZOMBIE_34, NpcIdentifiers.ZOMBIE_35, NpcIdentifiers.ZOMBIE_36, NpcIdentifiers.ZOMBIE_37, NpcIdentifiers.ZOMBIE_38, NpcIdentifiers.ZOMBIE_39, NpcIdentifiers.ZOMBIE_40, NpcIdentifiers.ZOMBIE_41, NpcIdentifiers.ZOMBIE_42, NpcIdentifiers.ZOMBIE_43, NpcIdentifiers.ZOMBIE_44, NpcIdentifiers.ZOMBIE_45, NpcIdentifiers.ZOMBIE_46, NpcIdentifiers.ZOMBIE_47, NpcIdentifiers.ZOMBIE_48, NpcIdentifiers.ZOMBIE_49, NpcIdentifiers.ZOMBIE_50, NpcIdentifiers.ZOMBIE_51, NpcIdentifiers.ZOMBIE_52, NpcIdentifiers.ZOMBIE_53, NpcIdentifiers.ZOMBIE_54, NpcIdentifiers.ZOMBIE_55, NpcIdentifiers.ZOMBIE_56, NpcIdentifiers.ZOMBIE_57, NpcIdentifiers.ZOMBIE_58, NpcIdentifiers.ZOMBIE_59, NpcIdentifiers.ZOMBIE_60, NpcIdentifiers.ZOMBIE_61, NpcIdentifiers.ZOMBIE_62, NpcIdentifiers.ZOMBIE_63, NpcIdentifiers.ZOMBIE_64, NpcIdentifiers.ZOMBIE_65, NpcIdentifiers.ZOMBIE_66, NpcIdentifiers.ZOMBIE_67, NpcIdentifiers.ZOMBIE_68),
    SKELETON(11, 1, 15, new Tile(3139,9870), new Tile(3018,3591), NpcIdentifiers.SKELETON, NpcIdentifiers.SKELETON_71, NpcIdentifiers.SKELETON_72, NpcIdentifiers.SKELETON_73, NpcIdentifiers.SKELETON_74, NpcIdentifiers.SKELETON_75, NpcIdentifiers.SKELETON_76, NpcIdentifiers.SKELETON_77, NpcIdentifiers.SKELETON_78, NpcIdentifiers.SKELETON_79, NpcIdentifiers.SKELETON_80, NpcIdentifiers.SKELETON_81, NpcIdentifiers.SKELETON_82, NpcIdentifiers.SKELETON_83, NpcIdentifiers.SKELETON_7265, NpcIdentifiers.SKELETON_CHAMPION, NpcIdentifiers.VETION, NpcIdentifiers.VETION_REBORN),
    GHOSTS(12, 1, 13, new Tile(1663,10024), NpcIdentifiers.GHOST, NpcIdentifiers.GHOST_86, NpcIdentifiers.GHOST_87, NpcIdentifiers.GHOST_88, NpcIdentifiers.GHOST_89, NpcIdentifiers.GHOST_90, NpcIdentifiers.GHOST_91, NpcIdentifiers.GHOST_92, NpcIdentifiers.GHOST_93, NpcIdentifiers.GHOST_94, NpcIdentifiers.GHOST_96, NpcIdentifiers.GHOST_97, NpcIdentifiers.GHOST_7263, NpcIdentifiers.GHOST_7264),
    BEARS(13, 1, 13, new Tile(2702,3333), new Tile(3110,3667), NpcIdentifiers.GRIZZLY_BEAR, NpcIdentifiers.BLACK_BEAR, NpcIdentifiers.BEAR_CUB, NpcIdentifiers.BEAR_CUB_3909, NpcIdentifiers.BEAR_CUB_9199, NpcIdentifiers.GRIZZLY_BEAR_CUB_3425, NpcIdentifiers.GRIZZLY_BEAR_3423, NpcIdentifiers.GRIZZLY_BEAR_CUB, NpcIdentifiers.CALLISTO, NpcIdentifiers.CALLISTO_6609),
    HILL_GIANTS(14, 1, 25, new Tile(3114,9841), NpcIdentifiers.HILL_GIANT, NpcIdentifiers.HILL_GIANT_2099, NpcIdentifiers.HILL_GIANT_2100, NpcIdentifiers.HILL_GIANT_2101, NpcIdentifiers.HILL_GIANT_2102, NpcIdentifiers.HILL_GIANT_2103, NpcIdentifiers.HILL_GIANT_7261),
    ICE_GIANT(15, 1, 50, new Tile(3063,9572), new Tile(2956,3897), NpcIdentifiers.ICE_GIANT, NpcIdentifiers.ICE_GIANT_2086, NpcIdentifiers.ICE_GIANT_2087, NpcIdentifiers.ICE_GIANT_2088, NpcIdentifiers.ICE_GIANT_2089, NpcIdentifiers.ICE_GIANT_7878, NpcIdentifiers.ICE_GIANT_7879, NpcIdentifiers.ICE_GIANT_7880),
    FIRE_GIANTS(16, 1, 65, new Tile(1632,10051), new Tile(3048,10341), NpcIdentifiers.FIRE_GIANT, NpcIdentifiers.FIRE_GIANT_2076, NpcIdentifiers.FIRE_GIANT_2077, NpcIdentifiers.FIRE_GIANT_2078, NpcIdentifiers.FIRE_GIANT_2079, NpcIdentifiers.FIRE_GIANT_2080, NpcIdentifiers.FIRE_GIANT_2081, NpcIdentifiers.FIRE_GIANT_2082, NpcIdentifiers.FIRE_GIANT_2083, NpcIdentifiers.FIRE_GIANT_2084, NpcIdentifiers.FIRE_GIANT_7251, NpcIdentifiers.FIRE_GIANT_7252),
    MOSS_GIANT(17, 1, 40, new Tile(2644,9486), new Tile(3140,3829), NpcIdentifiers.MOSS_GIANT, NpcIdentifiers.MOSS_GIANT_2091, NpcIdentifiers.MOSS_GIANT_2092, NpcIdentifiers.MOSS_GIANT_2093, NpcIdentifiers.MOSS_GIANT_3851, NpcIdentifiers.MOSS_GIANT_3852, NpcIdentifiers.MOSS_GIANT_7262, NpcIdentifiers.MOSS_GIANT_8736),
    TROLLS(18, 1, 60, new Tile(2866,3589), NpcIdentifiers.TROLL_8470, NpcIdentifiers.TROLL_8471, NpcIdentifiers.TROLL_8472, NpcIdentifiers.TROLL_8473, NpcIdentifiers.ICE_TROLL, NpcIdentifiers.ICE_TROLL_649, NpcIdentifiers.ICE_TROLL_650, NpcIdentifiers.ICE_TROLL_651, NpcIdentifiers.ICE_TROLL_652, NpcIdentifiers.ICE_TROLL_653, NpcIdentifiers.ICE_TROLL_654, NpcIdentifiers.ICE_TROLL_698, NpcIdentifiers.ICE_TROLL_699, NpcIdentifiers.ICE_TROLL_700, NpcIdentifiers.ICE_TROLL_701, NpcIdentifiers.ICE_TROLL_702, NpcIdentifiers.ICE_TROLL_703, NpcIdentifiers.ICE_TROLL_704, NpcIdentifiers.ICE_TROLL_705, NpcIdentifiers.MOUNTAIN_TROLL, NpcIdentifiers.MOUNTAIN_TROLL_937, NpcIdentifiers.MOUNTAIN_TROLL_938, NpcIdentifiers.MOUNTAIN_TROLL_939, NpcIdentifiers.MOUNTAIN_TROLL_940, NpcIdentifiers.MOUNTAIN_TROLL_941, NpcIdentifiers.MOUNTAIN_TROLL_942),
    ICE_WARRIOR(19, 1, 45, new Tile(3052,9581), new Tile(2959,3875), NpcIdentifiers.ICE_WARRIOR, NpcIdentifiers.ICE_WARRIOR_2842, NpcIdentifiers.ICE_WARRIOR_2851),
    OGRES(20, 1, 20, new Tile(2494,3110), NpcIdentifiers.OGRE_1153, NpcIdentifiers.OGRE_2095, NpcIdentifiers.OGRE_2096, NpcIdentifiers.OGRE_2233),
    HOBGOBLIN(21, 1, 20, new Tile(3020,9583), NpcIdentifiers.HOBGOBLIN_2241, NpcIdentifiers.HOBGOBLIN_3049, NpcIdentifiers.HOBGOBLIN_3050, NpcIdentifiers.HOBGOBLIN_3286, NpcIdentifiers.HOBGOBLIN_3287, NpcIdentifiers.HOBGOBLIN_3288, NpcIdentifiers.HOBGOBLIN_3289, NpcIdentifiers.HOBGOBLIN_4805, NpcIdentifiers.HOBGOBLIN_CHAMPION),
    DOGS(22, 1, 15, null, NpcIdentifiers.WILD_DOG, NpcIdentifiers.WILD_DOG_113),
    GHOULS(23, 1, 25, new Tile(3433,3461), NpcIdentifiers.GHOUL, NpcIdentifiers.GHOUL_CHAMPION),
    GREEN_DRAGONS(24, 1, 52, new Tile(2976,3613), new Tile(3225,10068), NpcIdentifiers.GREEN_DRAGON, NpcIdentifiers.GREEN_DRAGON_261, NpcIdentifiers.GREEN_DRAGON_262, NpcIdentifiers.GREEN_DRAGON_263, NpcIdentifiers.GREEN_DRAGON_264, NpcIdentifiers.GREEN_DRAGON_7868, NpcIdentifiers.GREEN_DRAGON_7869, NpcIdentifiers.GREEN_DRAGON_7870, NpcIdentifiers.GREEN_DRAGON_8073, NpcIdentifiers.GREEN_DRAGON_8076, NpcIdentifiers.GREEN_DRAGON_8082, NpcIdentifiers.BRUTAL_GREEN_DRAGON, NpcIdentifiers.BRUTAL_GREEN_DRAGON_8081, NpcIdentifiers.BABY_GREEN_DRAGON, NpcIdentifiers.BABY_GREEN_DRAGON_5872, NpcIdentifiers.BABY_GREEN_DRAGON_5873),
    BLUE_DRAGONS(25, 1, 65, new Tile(2904,9802), NpcIdentifiers.BLUE_DRAGON, NpcIdentifiers.BLUE_DRAGON_266, NpcIdentifiers.BLUE_DRAGON_267, NpcIdentifiers.BLUE_DRAGON_268, NpcIdentifiers.BLUE_DRAGON_269, NpcIdentifiers.BLUE_DRAGON_4385, NpcIdentifiers.BLUE_DRAGON_5878, NpcIdentifiers.BLUE_DRAGON_5879, NpcIdentifiers.BLUE_DRAGON_5880, NpcIdentifiers.BLUE_DRAGON_5881, NpcIdentifiers.BLUE_DRAGON_5882, NpcIdentifiers.BLUE_DRAGON_8074, NpcIdentifiers.BLUE_DRAGON_8077, NpcIdentifiers.BLUE_DRAGON_8083, NpcIdentifiers.BRUTAL_BLUE_DRAGON, NpcIdentifiers.BABY_BLUE_DRAGON, NpcIdentifiers.BABY_BLUE_DRAGON_242, NpcIdentifiers.BABY_BLUE_DRAGON_243),
    RED_DRAGONS(26, 1, 3, new Tile(2722,9518), NpcIdentifiers.RED_DRAGON, NpcIdentifiers.RED_DRAGON_248, NpcIdentifiers.RED_DRAGON_249, NpcIdentifiers.RED_DRAGON_250, NpcIdentifiers.RED_DRAGON_251, NpcIdentifiers.RED_DRAGON_8075, NpcIdentifiers.RED_DRAGON_8078, NpcIdentifiers.RED_DRAGON_8079, NpcIdentifiers.BRUTAL_RED_DRAGON, NpcIdentifiers.BRUTAL_RED_DRAGON_8087, NpcIdentifiers.BABY_RED_DRAGON, NpcIdentifiers.BABY_RED_DRAGON_244, NpcIdentifiers.BABY_RED_DRAGON_245, NpcIdentifiers.BABY_RED_DRAGON_246),
    BLACK_DRAGONS(27, 1, 3, new Tile(3222, 10200, 0), new Tile(3241,10203), NpcIdentifiers.BLACK_DRAGON, NpcIdentifiers.BLACK_DRAGON_253, NpcIdentifiers.BLACK_DRAGON_254, NpcIdentifiers.BLACK_DRAGON_255, NpcIdentifiers.BLACK_DRAGON_256, NpcIdentifiers.BLACK_DRAGON_257, NpcIdentifiers.BLACK_DRAGON_258, NpcIdentifiers.BLACK_DRAGON_259, NpcIdentifiers.BLACK_DRAGON_7861, NpcIdentifiers.BLACK_DRAGON_7862, NpcIdentifiers.BLACK_DRAGON_7863, NpcIdentifiers.BLACK_DRAGON_8084, NpcIdentifiers.BLACK_DRAGON_8085, NpcIdentifiers.BRUTAL_BLACK_DRAGON, NpcIdentifiers.BRUTAL_BLACK_DRAGON_8092, NpcIdentifiers.BRUTAL_BLACK_DRAGON_8092, NpcIdentifiers.KING_BLACK_DRAGON, CustomNpcIdentifiers.ANCIENT_KING_BLACK_DRAGON, NpcIdentifiers.BABY_BLACK_DRAGON, NpcIdentifiers.BABY_BLACK_DRAGON_1872, NpcIdentifiers.BABY_BLACK_DRAGON_7955),
    ...
    DAGANNOTH(35, 1, 75, new Tile(1665,9996), NpcIdentifiers.DAGANNOTH_PRIME, NpcIdentifiers.DAGANNOTH_REX, NpcIdentifiers.DAGANNOTH_SUPREME, NpcIdentifiers.DAGANNOTH_970, NpcIdentifiers.DAGANNOTH_971, NpcIdentifiers.DAGANNOTH_972, NpcIdentifiers.DAGANNOTH_973, NpcIdentifiers.DAGANNOTH_974, NpcIdentifiers.DAGANNOTH_975, NpcIdentifiers.DAGANNOTH_976, NpcIdentifiers.DAGANNOTH_977, NpcIdentifiers.DAGANNOTH_978, NpcIdentifiers.DAGANNOTH_979, NpcIdentifiers.DAGANNOTH_2259, NpcIdentifiers.DAGANNOTH_3185, NpcIdentifiers.DAGANNOTH_5942, NpcIdentifiers.DAGANNOTH_5943, NpcIdentifiers.DAGANNOTH_FLEDGELING, NpcIdentifiers.DAGANNOTH_7259, NpcIdentifiers.DAGANNOTH_7260),
    TUROTH(36, 55, 60, new Tile(2725,10007), NpcIdentifiers.TUROTH, NpcIdentifiers.TUROTH_427, NpcIdentifiers.TUROTH_428, NpcIdentifiers.TUROTH_429, NpcIdentifiers.TUROTH_430, NpcIdentifiers.TUROTH_431, NpcIdentifiers.TUROTH_432),
    CAVE_CRAWLER(37, 10, 10, new Tile(3189,9576), NpcIdentifiers.CAVE_CRAWLER, NpcIdentifiers.CAVE_CRAWLER_407, NpcIdentifiers.CAVE_CRAWLER_408, NpcIdentifiers.CAVE_CRAWLER_409, NpcIdentifiers.CHASM_CRAWLER),
    BANSHEES(38, 15, 15, new Tile(3439,3545), NpcIdentifiers.BANSHEE, NpcIdentifiers.SCREAMING_BANSHEE, NpcIdentifiers.SCREAMING_TWISTED_BANSHEE, NpcIdentifiers.TWISTED_BANSHEE),
    CRAWLING_HANDS(39, 5, 10, new Tile(3414,3559), NpcIdentifiers.CRAWLING_HAND_448, NpcIdentifiers.CRAWLING_HAND_449, NpcIdentifiers.CRAWLING_HAND_450, NpcIdentifiers.CRAWLING_HAND_451, NpcIdentifiers.CRAWLING_HAND_452, NpcIdentifiers.CRAWLING_HAND_453, NpcIdentifiers.CRAWLING_HAND_454, NpcIdentifiers.CRAWLING_HAND_455, NpcIdentifiers.CRAWLING_HAND_456, NpcIdentifiers.CRAWLING_HAND_457, NpcIdentifiers.CRUSHING_HAND),
    INFERNAL_MAGES(40, 45, 40, new Tile(3440,3569, 1), NpcIdentifiers.INFERNAL_MAGE, NpcIdentifiers.INFERNAL_MAGE_444, NpcIdentifiers.INFERNAL_MAGE_445, NpcIdentifiers.INFERNAL_MAGE_446, NpcIdentifiers.INFERNAL_MAGE_447, NpcIdentifiers.MALEVOLENT_MAGE),
    ABERRANT_SPECRES(41, 60, 65, new Tile(3427,3551,1), NpcIdentifiers.ABERRANT_SPECTRE, NpcIdentifiers.ABERRANT_SPECTRE_3, NpcIdentifiers.ABERRANT_SPECTRE_4, NpcIdentifiers.ABERRANT_SPECTRE_5, NpcIdentifiers.ABERRANT_SPECTRE_6, NpcIdentifiers.ABERRANT_SPECTRE_7, NpcIdentifiers.ABHORRENT_SPECTRE, NpcIdentifiers.DEVIANT_SPECTRE, NpcIdentifiers.REPUGNANT_SPECTRE),
    ABYSSAL_DEMON(42, 85, 85, new Tile(3417,3561,2), NpcIdentifiers.ABYSSAL_DEMON_415, NpcIdentifiers.ABYSSAL_DEMON_416, NpcIdentifiers.ABYSSAL_DEMON_7241, NpcIdentifiers.GREATER_ABYSSAL_DEMON, NpcIdentifiers.ABYSSAL_SIRE, NpcIdentifiers.ABYSSAL_SIRE_5887, NpcIdentifiers.ABYSSAL_SIRE_5888, NpcIdentifiers.ABYSSAL_SIRE_5889, NpcIdentifiers.ABYSSAL_SIRE_5890, NpcIdentifiers.ABYSSAL_SIRE_5891, NpcIdentifiers.ABYSSAL_SIRE_5908),
    BASILISKS(43, 40, 40, new Tile(2742,10010), NpcIdentifiers.BASILISK_417, NpcIdentifiers.BASILISK_418, NpcIdentifiers.BASILISK_9283, NpcIdentifiers.BASILISK_9284, NpcIdentifiers.BASILISK_9285, NpcIdentifiers.BASILISK_9286, NpcIdentifiers.BASILISK_KNIGHT, NpcIdentifiers.BASILISK_SENTINEL, NpcIdentifiers.BASILISK_YOUNGLING, NpcIdentifiers.MONSTROUS_BASILISK, NpcIdentifiers.MONSTROUS_BASILISK_9287, NpcIdentifiers.MONSTROUS_BASILISK_9288),
    COCKATRICE(44, 25, 25, new Tile(2792,10034), NpcIdentifiers.COCKATRICE_419, NpcIdentifiers.COCKATRICE_420, NpcIdentifiers.COCKATHRICE),
    ...
    DWARVES(57, 1, 6, new Tile(3010,9812), NpcIdentifiers.DWARF, NpcIdentifiers.DWARF_292, NpcIdentifiers.DWARF_294, NpcIdentifiers.DWARF_295, NpcIdentifiers.DWARF_296, NpcIdentifiers.DWARF_1401, NpcIdentifiers.DWARF_1402, NpcIdentifiers.DWARF_1403, NpcIdentifiers.DWARF_1404, NpcIdentifiers.DWARF_1405, NpcIdentifiers.DWARF_1406, NpcIdentifiers.DWARF_1407, NpcIdentifiers.DWARF_1408),
    BRONZE_DRAGONS(58, 1, 75, new Tile(2736,9489), NpcIdentifiers.BRONZE_DRAGON, NpcIdentifiers.BRONZE_DRAGON_271, NpcIdentifiers.BRONZE_DRAGON_7253),
    IRON_DRAGONS(59, 1, 80, new Tile(2720,9460), NpcIdentifiers.IRON_DRAGON, NpcIdentifiers.IRON_DRAGON_273, NpcIdentifiers.IRON_DRAGON_7254, NpcIdentifiers.IRON_DRAGON_8080),
    STEEL_DRAGONS(60, 1, 80, new Tile(2714,9435), NpcIdentifiers.STEEL_DRAGON_274, NpcIdentifiers.STEEL_DRAGON_275, NpcIdentifiers.STEEL_DRAGON_7255, NpcIdentifiers.STEEL_DRAGON_8086),
    WALL_BEASTS(61, 35, 30, null, NpcIdentifiers.WALL_BEAST),
    CAVE_SLIMES(62, 17, 15, new Tile(3182,9550), NpcIdentifiers.CAVE_SLIME),
    CAVE_BUGS(63, 7, 7, new Tile(3189,9576), NpcIdentifiers.CAVE_BUG, NpcIdentifiers.CAVE_BUG_483),
    SHADES(64, 1, 30, new Tile(1605,10039), NpcIdentifiers.SHADE, NpcIdentifiers.SHADE_6740, NpcIdentifiers.SHADE_7258),
    CROCODILES(65, 1, 50, null, NpcIdentifiers.CROCODILE),
    DARK_BEASTS(66, 90, 90, new Tile(2027,4636), NpcIdentifiers.DARK_BEAST, NpcIdentifiers.DARK_BEAST_7250, NpcIdentifiers.NIGHT_BEAST),
    ...
    ANKOUS(79, 1, 40, new Tile(2477,9802), new Tile(3183,10195), NpcIdentifiers.ANKOU, NpcIdentifiers.ANKOU_2515, NpcIdentifiers.ANKOU_2516, NpcIdentifiers.ANKOU_2517, NpcIdentifiers.ANKOU_2518, NpcIdentifiers.ANKOU_2519, NpcIdentifiers.ANKOU_6608, NpcIdentifiers.ANKOU_7257, NpcIdentifiers.ANKOU_7864, NpcIdentifiers.DARK_ANKOU),
    CAVE_HORRORS(80, 58, 85, new Tile(3821,9414), NpcIdentifiers.CAVE_HORROR, NpcIdentifiers.CAVE_HORROR_1048, NpcIdentifiers.CAVE_HORROR_1049, NpcIdentifiers.CAVE_HORROR_1050, NpcIdentifiers.CAVE_HORROR_1051, NpcIdentifiers.CAVE_ABOMINATION),
    ...
    SUQAHS(83, 1, 3, new Tile(2149,3942), NpcIdentifiers.SUQAH, NpcIdentifiers.SUQAH_788, NpcIdentifiers.SUQAH_789, NpcIdentifiers.SUQAH_790, NpcIdentifiers.SUQAH_791, NpcIdentifiers.SUQAH_792, NpcIdentifiers.SUQAH_793),
    BRINE_RAT(84, 47, 47, new Tile(2705,10133), NpcIdentifiers.BRINE_RAT),
    ...
    ADAMANT_DRAGONS(108, 1, 75, new Tile(1558,5076), NpcIdentifiers.ADAMANT_DRAGON, NpcIdentifiers.ADAMANT_DRAGON_8090),
    RUNE_DRAGONS(109, 1, 75, new Tile(1580,5070), NpcIdentifiers.RUNE_DRAGON, NpcIdentifiers.RUNE_DRAGON_8031, NpcIdentifiers.RUNE_DRAGON_8091),
    BANDITS(110, 1, 3, new Tile(3032, 3681), new Tile(3037,3651), NpcIdentifiers.BANDIT, NpcIdentifiers.BANDIT_691, NpcIdentifiers.BANDIT_692, NpcIdentifiers.BANDIT_693, NpcIdentifiers.BANDIT_694, NpcIdentifiers.BANDIT_695, NpcIdentifiers.BANDIT_734, NpcIdentifiers.BANDIT_735, NpcIdentifiers.BANDIT_736, NpcIdentifiers.BANDIT_737, NpcIdentifiers.BANDIT_1026, NpcIdentifiers.GUARD_BANDIT, NpcIdentifiers.BANDIT_6605, NpcIdentifiers.BANDIT_1026),
    BLACK_KNIGHT(111, 1, 3, new Tile(3311,3769), new Tile(3311,3769), NpcIdentifiers.BLACK_KNIGHT, NpcIdentifiers.BLACK_KNIGHT_517, NpcIdentifiers.BLACK_KNIGHT_1545, NpcIdentifiers.BLACK_KNIGHT_4331, NpcIdentifiers.BLACK_KNIGHT_4959, NpcIdentifiers.BLACK_KNIGHT_4960),
    DARK_WARRIOR(112, 1, 3, new Tile(3009,3634), new Tile(3029,3061), NpcIdentifiers.DARK_WARRIOR, NpcIdentifiers.DARK_WARRIOR_6606),
    MAMMOTH(113, 1, 3, null, NpcIdentifiers.MAMMOTH),
    PIRATE(114, 1, 3, new Tile(3046, 3955), new Tile(3045,3956), NpcIdentifiers.PIRATE, NpcIdentifiers.PIRATE, NpcIdentifiers.PIRATE_522, NpcIdentifiers.PIRATE_523, NpcIdentifiers.PIRATE_524, NpcIdentifiers.PIRATE_1447, NpcIdentifiers.PIRATE_4043, NpcIdentifiers.PIRATE_4044, NpcIdentifiers.PIRATE_4045, NpcIdentifiers.PIRATE_4046, NpcIdentifiers.PIRATE_4047, NpcIdentifiers.PIRATE_4048, NpcIdentifiers.PIRATE_4049, NpcIdentifiers.PIRATE_4050, NpcIdentifiers.PIRATE_4051, NpcIdentifiers.PIRATE_4052, NpcIdentifiers.PIRATE_6993, NpcIdentifiers.PIRATE_6994, NpcIdentifiers.PIRATE_6995, NpcIdentifiers.PIRATE_7282, NpcIdentifiers.PIRATE_7917, NpcIdentifiers.PIRATE_7918),
    ...
    BARRELCHEST(119, 1, 95,true, new Tile(3287, 3884), NpcIdentifiers.BARRELCHEST_6342, CustomNpcIdentifiers.ANCIENT_BARRELCHEST),
    ...
    ABYSSAL_SIRE(121, 85, 95,true, new Tile(3105, 4838), NpcIdentifiers.ABYSSAL_SIRE, NpcIdentifiers.ABYSSAL_SIRE_5887, NpcIdentifiers.ABYSSAL_SIRE_5888, NpcIdentifiers.ABYSSAL_SIRE_5889, NpcIdentifiers.ABYSSAL_SIRE_5890, NpcIdentifiers.ABYSSAL_SIRE_5891, NpcIdentifiers.ABYSSAL_SIRE_5908),
    BARROWS(122, 1, 85,true, new Tile(3565,3308), NpcIdentifiers.AHRIM_THE_BLIGHTED, NpcIdentifiers.DHAROK_THE_WRETCHED, NpcIdentifiers.GUTHAN_THE_INFESTED, NpcIdentifiers.KARIL_THE_TAINTED, NpcIdentifiers.TORAG_THE_CORRUPTED, NpcIdentifiers.VERAC_THE_DEFILED),
    CALLISTO(123, 1, 95,true, new Tile(3307, 3837), new Tile(3295,3839), NpcIdentifiers.CALLISTO, NpcIdentifiers.CALLISTO_6609),
    CERBERUS(124, 91, 95,true, new Tile(1292,1252), NpcIdentifiers.CERBERUS, NpcIdentifiers.CERBERUS_5863, NpcIdentifiers.CERBERUS_5866),
    CHAOS_ELEMENTAL(125, 1, 95,true, new Tile(3269, 3927), new Tile(3307,3916), NpcIdentifiers.CHAOS_ELEMENTAL, NpcIdentifiers.CHAOS_ELEMENTAL_6505, CustomNpcIdentifiers.ANCIENT_CHAOS_ELEMENTAL),
    CHAOS_FANATIC(126, 1, 85,true, new Tile(2992, 3851), new Tile(2922,3851), NpcIdentifiers.CHAOS_FANATIC),
    COMMANDER_ZILYANA(127, 1, 95,true, new Tile(2912,5267, 0), NpcIdentifiers.COMMANDER_ZILYANA),
    CRAZY_ARCHAEOLOGIST(128, 1, 85,true, new Tile(2976, 3694), new Tile(2976,3694), NpcIdentifiers.CRAZY_ARCHAEOLOGIST),
    DAGANNOTH_KINGS(129, 1, 85,true, new Tile(1912,4367), NpcIdentifiers.DAGANNOTH_PRIME, NpcIdentifiers.DAGANNOTH_REX, NpcIdentifiers.DAGANNOTH_SUPREME),
    GENERAL_GRAARDOR(130, 1, 95,true, new Tile(2861,5354, 2), NpcIdentifiers.GENERAL_GRAARDOR),
    GIANT_MOLE(131, 1, 85,true, new Tile(1760,5163), NpcIdentifiers.GIANT_MOLE, NpcIdentifiers.GIANT_MOLE_6499),
    GROTESQUE_GUARDIANS(132, 75, 95,true, null, NpcIdentifiers.DUSK, NpcIdentifiers.DAWN),
    KRIL_TSUTSAROTH(133, 1, 95,true, new Tile(2925, 5336, 2), NpcIdentifiers.KRIL_TSUTSAROTH),
    KALPHITE_QUEEN(134, 1, 95,true, new Tile(3507, 9494, 2), NpcIdentifiers.KALPHITE_QUEEN_6500, NpcIdentifiers.KALPHITE_QUEEN_6501),
    ...
    KREE_ARRA(137, 1, 95,true, new Tile(2841, 5291, 2), NpcIdentifiers.KREEARRA),
    ...
    THERMONUCLEAR_SMOKE_DEVIL(140, 93, 95,true, new Tile(2369,9449), NpcIdentifiers.THERMONUCLEAR_SMOKE_DEVIL),
    VENENATIS(141, 1, 95,true, new Tile(3319, 3745), new Tile(3338,3730), NpcIdentifiers.VENENATIS, NpcIdentifiers.VENENATIS_6610),
    VETION(142, 1, 95,true, new Tile(3239, 3783), new Tile(3237,3800), NpcIdentifiers.VETION, NpcIdentifiers.VETION_REBORN),
    VORKATH(143, 1, 112,true, new Tile(2273, 4049), NpcIdentifiers.VORKATH_8061),
    ZULRAH(144, 1, 95,true, new Tile(2204,3056), NpcIdentifiers.ZULRAH, NpcIdentifiers.ZULRAH_2043, NpcIdentifiers.ZULRAH_2044),
    ...
    public Tile wildTeleportLocation;
    public int[] ids;

    SlayerCreature(int uid, int req, int cbreq, Tile teleportLocation, Tile wildTeleportLocation, int... ids) {
        this.uid = uid;
        this.req = req;
        this.cbreq = cbreq;
        this.bossTask = false;
        this.teleportLocation = teleportLocation;
        this.wildTeleportLocation = wildTeleportLocation;
        this.ids = ids;
    }

    SlayerCreature(int uid, int req, int cbreq, boolean bossTask, Tile teleportLocation, Tile wildTeleportLocation, int... ids) {
        this.uid = uid;
        this.req = req;
        this.cbreq = cbreq;
        this.bossTask = bossTask;
        this.teleportLocation = teleportLocation;
        this.wildTeleportLocation = null;
        this.ids = ids;
    }
