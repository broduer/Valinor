...
public enum Plants {
    ...
    APPLE_TREE(ItemIdentifiers.APPLE_SAPLING, ItemIdentifiers.COOKING_APPLE, 8, 8 + 13, 8 + 19, 8 + 25, 8 + 26, 27, 0, SeedType.FRUIT_TREE, 22.0, 1199.0, 8.5, 7),
    BANANA_TREE(ItemIdentifiers.BANANA_SAPLING, ItemIdentifiers.BANANA, 35, 35 + 13, 35 + 19, 35 + 25, 35 + 26, 33, 0, SeedType.FRUIT_TREE, 28.0, 1750.5, 10.5, 7),
    ORANGE_TREE(ItemIdentifiers.ORANGE_SAPLING, ItemIdentifiers.ORANGE, 62, 62 + 13, 62 + 19, 62 + 25, 62 + 26, 39, 0, SeedType.FRUIT_TREE, 35.0, 2470.2, 13.5, 7),
    ...
    TOADFLAX(5296, ItemIdentifiers.GRIMY_TOADFLAX, 39, 173, 170, 36, 80, SeedType.HERB, 34, 38, 4), //5296
    ...
    SNAPDRAGON(5300, ItemIdentifiers.GRIMY_SNAPDRAGON, 75, 173, 170, 62, 80, SeedType.HERB, 87, 98, 4), //43585
    CADANTINE(5301,	215, 82, 173, 170, 67, 80, SeedType.HERB, 106, 120, 4), //285
    LANTADYME(5302, ItemIdentifiers.GRIMY_LANTADYME, 89, 173, 170, 73, 80,	SeedType.HERB, 134, 151, 4), //967
