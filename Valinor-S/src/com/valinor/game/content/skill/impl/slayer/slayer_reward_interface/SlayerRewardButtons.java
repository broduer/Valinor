...
public enum SlayerRewardButtons {
     ...
     * Unlock Buttons
     */
    BONUS_SLAYER_POINTS(new int[]{63406}, 0, SlayerRewardActions.UNLOCK_BUTTON, 750),
    COINS_FROM_KILLING_BOSSES(new int[]{63407}, 0, SlayerRewardActions.UNLOCK_BUTTON, 751),
    DOUBLE_DROP(new int[]{63408}, 0, SlayerRewardActions.UNLOCK_BUTTON, 752),
    ...
    REVENANTS_CAVE_TELEPORT(new int[]{63411}, 0, SlayerRewardActions.UNLOCK_BUTTON, 755),
    LARRANS_LUCK(new int[]{63412}, 0, SlayerRewardActions.UNLOCK_BUTTON, 756),
    NO_SLAYER_REQUIREMENT(new int[]{63413}, 0, SlayerRewardActions.UNLOCK_BUTTON, 757),
    THIEVING_BOOST(new int[]{63414}, 0, SlayerRewardActions.UNLOCK_BUTTON, 758),
    DROP_RATE_BOOST(new int[]{63415}, 0, SlayerRewardActions.UNLOCK_BUTTON, 759),
    SUPPLY_DROP(new int[]{63416}, 0, SlayerRewardActions.UNLOCK_BUTTON, 760),
    ...
    EXPERIENCE_BOOSTER(new int[]{63421}, 0, SlayerRewardActions.UNLOCK_BUTTON, 765),
    ...
    TASK_TELEPORTATION(new int[]{63425}, 0, SlayerRewardActions.UNLOCK_BUTTON, 769),
    ...
    MALEVOLENT_MASQUERADE(new int[]{63428}, 0, SlayerRewardActions.UNLOCK_BUTTON, 772),
