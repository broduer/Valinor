...
public class RiskManagement {
    ...
    public void updateCarriedWealthProtection() {
        ...
        player.debugMessage("Your wealth risked is "+ Utils.formatNumber(risked)+" Coins.");
    }
    ...
    public void reward() {
        ...
        if (reward != null) {
            message = "[<col=" + Color.RED.getColorValue() + ">Daredevil</col>]:</col> You took a risk and were rewarded with <col=" + Color.DARK_GREEN.getColorValue() + ">" + amount + " " + reward.name() + "</col>!";
            ...
            if (worldMessage) {
                message = "[<col=" + Color.RED.getColorValue() + ">Daredevil</col>]:</col> <col=" + Color.HOTPINK.getColorValue() + ">" + player.getUsername() + "</col> took a risk and was rewarded with <col=" + Color.DARK_GREEN.getColorValue() + ">" + amount + " " + reward.name() + "</col>!";
