...
import static com.valinor.game.world.entity.AttributeKey.CUSTOM_DUEL_RULE;
import static com.valinor.game.world.entity.AttributeKey.SEND_DUEL_REQUEST;
...
public class Dueling {
    ...
    public void requestDuel(Player t_) {
        ...
        if (player.gameMode() == GameMode.INSTANT_PKER && t_.gameMode() != GameMode.INSTANT_PKER) {
            player.message("You cannot duel "+t_.getUsername()+" you are a Instant Pker.");
            return;
        }
