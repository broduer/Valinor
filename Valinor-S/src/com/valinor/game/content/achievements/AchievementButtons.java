...
public class AchievementButtons {
    ...
    public static boolean handleButtons(Player player, int buttonId) {
        ...
        if (buttonId == 39409) {
            ...
            AchievementWidget.sendInterfaceForAchievement(player, Achievements.BARROWS_II);
        ...
        if (buttonId == 39410) {
            ...
            AchievementWidget.sendInterfaceForAchievement(player, Achievements.BARK_SCORPION);
