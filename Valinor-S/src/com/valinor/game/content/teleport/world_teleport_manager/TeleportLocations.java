...
public enum TeleportLocations {
    ...
    NEX(NpcIdentifiers.NEX, 2800, AttributeKey.NEX_KC, new Tile(2904, 5203,0), Category.BOSSES, false, true, true, new Item(NEXLING), new Item(ANCIENT_HILT), new Item(NIHIL_HORN), new Item(ZARYTE_VAMBRACES), new Item(TORVA_FULL_HELM), new Item(TORVA_PLATEBODY), new Item(TORVA_PLATELEGS)),
    ENRAGED_GORILLA(CustomNpcIdentifiers.ENRAGED_GORILLA_MELEE, 2800, AttributeKey.ENRAGED_GORILLA_KILLS, new Tile(3168, 3720, 0), Category.BOSSES, true, true, true, new Item(AMULET_OF_TORTURE), new Item(NECKLACE_OF_ANGUISH), new Item(LIGHT_BALLISTA), new Item(HEAVY_BALLISTA), new Item(TORMENTED_BRACELET), new Item(RING_OF_SUFFERING), new Item(TORMENTED_ORNAMENT_KIT), new Item(ANGUISH_ORNAMENT_KIT), new Item(TORTURE_ORNAMENT_KIT)),
