...
public enum Conversions {
    ...
    CRYSTAL_OF_IORWERTH_BOW(new Item(BOW_OF_FAERDHINEN_C_25886), new Item[] { new Item(BOW_OF_FAERDHINEN_C_25884), new Item(CRYSTAL_OF_IORWERTH)}),
    ...
    CRYSTAL_OF_TRAHAEARN_BOW(new Item(ItemIdentifiers.BOW_OF_FAERDHINEN_C_25888), new Item[] { new Item(BOW_OF_FAERDHINEN_C_25884), new Item(CRYSTAL_OF_TRAHAEARN)}),
    ...
    CRYSTAL_OF_CADARN_BOW(new Item(ItemIdentifiers.BOW_OF_FAERDHINEN_C_25890), new Item[] { new Item(BOW_OF_FAERDHINEN_C_25884), new Item(CRYSTAL_OF_CADARN)}),
    ...
    CRYSTAL_OF_CRWYS_BOW(new Item(ItemIdentifiers.BOW_OF_FAERDHINEN_C_25892), new Item[] { new Item(BOW_OF_FAERDHINEN_C_25884), new Item(CRYSTAL_OF_CRWYS)}),
    ...
    CRYSTAL_OF_MEILYR_BOW(new Item(ItemIdentifiers.BOW_OF_FAERDHINEN_C_25894), new Item[] { new Item(BOW_OF_FAERDHINEN_C_25884), new Item(CRYSTAL_OF_MEILYR)}),
    ...
    CRYSTAL_OF_HEFIN_BOW(new Item(ItemIdentifiers.BOW_OF_FAERDHINEN_C), new Item[] { new Item(BOW_OF_FAERDHINEN_C_25884), new Item(CRYSTAL_OF_HEFIN)}),
    ...
    CRYSTAL_OF_AMLODDL_BOW(new Item(BOW_OF_FAERDHINEN_C_25896), new Item[] { new Item(BOW_OF_FAERDHINEN_C_25884), new Item(CRYSTAL_OF_AMLODD)}),
